...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GoToDivide(values) {
            if (values[1] != 1) {
                swal({
                    title: "Operatie nepermisa", text: "Se pot diviza numai cererile in starea solicitat",
                    type: "warning"
                });
            }
            else {
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">
                ...
                <dx:ASPxButton ID="btnSolNoua" runat="server" Text="Solicitare noua" OnClick="btnNew_Click" oncontextMenu="ctx(this,event)" >
            ...
            <td colspan="2">
                <div style="display:inline-block; line-height:22px; vertical-align:middle; padding:15px 0px 15px 0px;">
                    ...
                    <div style="float:left; padding-right:15px;">
                        <dx:ASPxComboBox ID="cmbViz" ClientInstanceName="cmbViz" ClientIDMode="Static" runat="server" Width="250px" AutoPostBack="false" >
                            <Items>
                                <dx:ListEditItem Text = "De aprobat" Value = "1" Selected = "true" />
                                <dx:ListEditItem Text = "Toate cererile" Value = "2" />
                            </Items>
                    ...
                    <div style="float:left; padding-right:15px;">
                        <dx:ASPxComboBox ID="cmbRol" ClientInstanceName="cmbRol" ClientIDMode="Static" runat="server" Width="250px" ValueField="Id" TextField="Denumire" ValueType="System.Int32" AutoPostBack="false" />
                    </div>
            ...
            <td colspan="2">
                ...
                <dx:ASPxGridView ID="grDate" runat="server" ClientInstanceName="grDate" ClientIDMode="Static" Width="100%" AutoGenerateColumns="false" OnCustomCallback="grDate_CustomCallback" OnRowUpdating="grDate_RowUpdating" OnDataBinding="grDate_DataBinding" OnHtmlDataCellPrepared="grDate_HtmlDataCellPrepared" OnHtmlEditFormCreated="grDate_HtmlEditFormCreated" OnCellEditorInitialize="grDate_CellEditorInitialize" OnCustomButtonInitialize="grDate_CustomButtonInitialize" OnCommandButtonInitialize="grDate_CommandButtonInitialize" >
                    ...
                    <Columns>
                        ...
                        <dx:GridViewCommandColumn VisibleIndex="1" ButtonType="Image" ShowEditButton="true" Caption=" " Name="butoaneGrid" >
                            <CustomButtons>
