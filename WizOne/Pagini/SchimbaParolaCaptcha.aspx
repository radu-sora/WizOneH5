<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchimbaParolaCaptcha.aspx.cs" Inherits="WizOne.Pagini.SchimbaParolaCaptcha" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="outer">
            <div class="ssSchimba">
                ...
                <div>
                    <div class="g-recaptcha" data-sitekey="6Lckrq0UAAAAANS6NOM2-zPpYFfrKuWMq0r48keQ"></div>
                </div>
             </div>
