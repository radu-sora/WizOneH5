        ...
        protected void btnStergePontari_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rez != "")
                {
                    ...
                    if (Constante.tipBD == 2)
                        strDel = $@" DELETE FROM ""Ptj_Intrari"" A
        ...
        protected void popUpModif_WindowCallback(object source, PopupWindowCallbackArgs e)
        {
            try
            {
                ...
                string sqlVal = $@"SELECT COALESCE(A.""OreInVal"",'') AS ""ValAbs"", A.""DenumireScurta"", A.""Id"", 
                        ...
                        WHERE A.""OreInVal"" IS NOT NULL AND RTRIM(LTRIM(A.""OreInVal"")) <> '' AND A.""InPontaj"" = 1 AND B.""IdContract"" = P.""IdContract"" AND C.""IdRol"" = {cmbRol.Value} AND
                        (
                ...
                for (int i = 0; i < dtVal.Rows.Count; i++)
                {
                    ...
                    string id = dr["ValAbs"] + "_" + General.Nz(dr["DenumireScurta"], "").ToString().Replace(" ","") + "_" + dr["VerificareNrMaxOre"];
            ...
            try
            {
                ...
                if (Dami.ValoareParam("") == "2")
                    ...
                    strSql = $@"SELECT *,
                                ...
                                A.F10022 AS DataInceput, ddp.DataPlecare AS DataSfarsit,  A.F10008 + ' ' + A.F10009 AS AngajatNume, C.Id AS IdContract, 
                                ...
                                B.F100958, B.F100959,
                                H.F00507 AS ""Sectie"",I.F00608 AS ""Dept"", S2.F00204 AS ""Companie"", S3.F00305 AS ""Subcompanie"", S4.F00406 AS ""Filiala"", S7.F00709 AS ""Subdept"", S8.F00810 AS ""Birou"",
                    ...
                    strSql = $@"SELECT A.*,
                                ...
                                FROM (
                                SELECT COALESCE({idRol},1) AS ""IdRol"", A.F100901, {dtInc}  AS ""ZiuaInc"", 
