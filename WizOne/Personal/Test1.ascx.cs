    ...
    public partial class Test1 : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Test1_DataList.DataSource = table;
                Test1_DataList.DataBind();


                ASPxTextBox txtV = Test1_DataList.Items[0].FindControl("txtVarsta") as ASPxTextBox;
                ASPxRadioButton chk1 = Test1_DataList.Items[0].FindControl("chkM") as ASPxRadioButton;
                ASPxRadioButton chk2 = Test1_DataList.Items[0].FindControl("chkF") as ASPxRadioButton;
                ...
                ASPxTextBox txtMarca = Test1_DataList.Items[0].FindControl("txtMarcaDI") as ASPxTextBox;
                ...
                {
                    ASPxLabel lbl = Test1_DataList.Items[0].FindControl(etichete[i]) as ASPxLabel;
                ...
                {
                    ASPxRadioButton radio = Test1_DataList.Items[0].FindControl(butoaneRadio[i]) as ASPxRadioButton;
                ...
                {
                    ASPxButton btn = Test1_DataList.Items[0].FindControl(butoane[i]) as ASPxButton;
                ...
                HtmlGenericControl lgIdent = Test1_DataList.Items[0].FindControl("lgIdent") as HtmlGenericControl;
                lgIdent.InnerText = Dami.TraduCuvant("Date unice de identificare");
                HtmlGenericControl lgSex = Test1_DataList.Items[0].FindControl("lgSex") as HtmlGenericControl;
                lgSex.InnerText = Dami.TraduCuvant("Data nasterii si Sex");
                HtmlGenericControl lgNume = Test1_DataList.Items[0].FindControl("lgNume") as HtmlGenericControl;
                lgNume.InnerText = Dami.TraduCuvant("Nume si prenume");

                if (Convert.ToInt32(General.Nz(Session["IdClient"], 1)) == 22)
                {//DNATA
                    ASPxTextBox txtCNPDI = Test1_DataList.Items[0].FindControl("txtCNPDI") as ASPxTextBox;
                    ASPxTextBox txtNume = Test1_DataList.Items[0].FindControl("txtNume") as ASPxTextBox;
                    ASPxTextBox txtPrenume = Test1_DataList.Items[0].FindControl("txtPrenume") as ASPxTextBox;
                ...
                General.SecuritatePersonal(Test1_DataList, Convert.ToInt32(Session["UserId"].ToString()));
            }
            catch (Exception ex)
            {
            ...
            {  
                ...
                case "txtMarcaDI":
                    if (VerificaMarca(param[1]))
                    {
                        ...
                        Test1_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Marca este deja alocata!");
                    break;
                case "txtEIDDI":
                ...
                case "deDataNasterii":
                    ...
                    Session["InformatiaCurentaPersonal"] = ds;
                    ASPxTextBox txtVarsta = Test1_DataList.Items[0].FindControl("txtVarsta") as ASPxTextBox;
                ...
                case "btnPrenume":
                    ...
                    break;
                case "PreluareDate":
                    ASPxTextBox txtCNP = Test1_DataList.Items[0].FindControl("txtCNPDI") as ASPxTextBox;
            ...
            try
            {
                ...
                if (txtCNP.Text != null && txtCNP.Text != "")
                {
                    ...
                    if (General.VerificaCNP(cnp))
                    {
                        ...
                        if (varsta < 16)
                        {
                            Test1_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Nu puteti angaja o persoana cu varsta mai mica de 16 ani!");
                            return false;
                        }
                        ...
                        ASPxTextBox txtMarcaUnica = Test1_DataList.Items[0].FindControl("txtMarcaUnica") as ASPxTextBox;                      
                        ...
                        if (Session["esteNou"] != null && Session["esteNou"].ToString().Length > 0 && Session["esteNou"].ToString() == "true")
                        {
                            ...
                            {
                                Test1_pnlCtl.JSProperties["cp_InfoMessage"] = Dami.TraduCuvant("Angajatul exista deja in baza de date.\nDoriti preluarea datelor de pe cel mai recent contract?");
                    ...
                    {
                        Test1_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("CNP invalid");
                    }
                }
            }
            catch (Exception ex)
        ...
        private void DataNasterii(string cnp)
        {
            try
            {
                ...
                ASPxDateEdit deDataNasterii = Test1_DataList.Items[0].FindControl("deDataNasterii") as ASPxDateEdit;
        ...
        public void PreluareDateContract(string CNP)
        {
            try
            {
                ...
                if (dt100 != null && dt100.Rows.Count > 0)
                {
                    ...
                    ASPxTextBox txtNume = Test1_DataList.Items[0].FindControl("txtNume") as ASPxTextBox;
                    ASPxTextBox txtPreume = Test1_DataList.Items[0].FindControl("txtPrenume") as ASPxTextBox;
                    ASPxTextBox txtNumeAnt = Test1_DataList.Items[0].FindControl("txtNumeAnt") as ASPxTextBox;
                    ASPxDateEdit deDataModifNume = Test1_DataList.Items[0].FindControl("deDataModifNume") as ASPxDateEdit;
                    ASPxComboBox cmbStareCivila = Test1_DataList.Items[0].FindControl("cmbStareCivila") as ASPxComboBox;
        ...
        //{
        //    Test1_pnlCtl.Controls.Add(new LiteralControl());
        //    WebControl script = new WebControl(HtmlTextWriterTag.Script);
        //    Test1_pnlCtl.Controls.Add(script);
