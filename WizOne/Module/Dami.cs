    ...
    public class Dami
    {
        ...
        internal static string SelectCereri(int totiAngajatii = 0)
        {
            ...
            try
            {
                ...
                string condElimDubluri = " and abs(b.IdSuper) = (select max(abs(IdSuper)) from Ptj_CereriIstoric where b.idUser=" + HttpContext.Current.Session["UserId"] + " and idcerere=a.id ) ";
