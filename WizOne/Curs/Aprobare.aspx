<%@ Page Title="" Language="C#" MasterPageFile="~/Cadru.Master" AutoEventWireup="true" Async="true" CodeBehind="Aprobare.aspx.cs" Inherits="WizOne.Curs.Aprobare" %>
    ...
    <table width="50%">   
        <tr>
            ...
            <td align="left">
                ...
                <dx:ASPxComboBox ID="cmbRol" runat="server" ClientInstanceName="cmbRol" ClientIDMode="Static" Width="215px" ValueField="Id" DropDownWidth="200" 
