...
<body>
    <form id="form1" runat="server">
        ...
        <div class="div_hor">
            ...
            <label id="lblAddCmp" runat="server">Camp</label>
            <dx:ASPxComboBox ID="cmbAddCmp" runat="server" ClientInstanceName="cmbAddCmp" AutoPostBack="false" CssClass="cmbTip" Width="170px" ValueField="Id" ValueType="System.Int32" TextField="Denumire" />
            <label style="padding-left:0; padding-right:0;">&nbsp;</label>
        ...
        <dx:ASPxRoundPanel ID="pnlMail" runat="server" ShowHeader="true" ShowCollapseButton="true" AllowCollapsingByHeaderClick="true" HeaderText="Trimite mail la" CssClass="pnlAlign indentright20" >
            ...
            <PanelCollection>
                <dx:PanelContent>
                    ...
                    <asp:UpdatePanel ID="up1" runat="server" OnUnload="up1_Unload">
                        <ContentTemplate>
                            <div class="div_ver">
                                <table>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <dx:ASPxComboBox ID="cmbTip" runat="server" AutoPostBack="true" CssClass="cmbTip" Width="120px" OnSelectedIndexChanged="cmbTip_SelectedIndexChanged">
                                                <Items>
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="btnSaveMail" runat="server" OnClick="btnSaveMail_Click" Width="30px">
                                                <Image Url="~/Fisiere/Imagini/Icoane/salveaza.png"></Image>
                                            </dx:ASPxButton>
                                        </td>
                                    </tr>
                                </table>
                                <dx:ASPxGridView ID="grDateMail" runat="server" ClientInstanceName="grDateMail" Width="100%" AutoGenerateColumns="false" OnRowDeleting="grDateMail_RowDeleting" OnRowUpdating="grDateMail_RowUpdating" >
                                    <SettingsBehavior AllowFocusedRow="true" />
                                    <Settings ShowFilterRow="False" ShowGroupPanel="False" ShowColumnHeaders="false" />
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="MailDestinatie" Name="Destinatie" Caption="Destinatie" Width="50px" />
                                        <dx:GridViewDataCheckColumn FieldName="IncludeLinkAprobare" Name="Link" Caption="Adauga link aprobare" Width="25px" />
                                        <dx:GridViewCommandColumn Width="50px" ShowDeleteButton="true" ShowEditButton="true" VisibleIndex="4" ButtonType="Image" Caption=" " />
                                    </Columns>
                        ...
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="btnSaveMail" EventName="Click" />
                        </Triggers>
                    </asp:UpdatePanel>
            ...
            <PanelCollection>
                <dx:PanelContent>
                            ...
                            <div class="div_ver">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="div_hor" style="margin-bottom:0;">
                                                ...
                                                <dx:ASPxComboBox ID="cmbVal" runat="server" ClientInstanceName="cmbVal" AutoPostBack="false" CssClass="cmbTip" Width="8px" ValueField="Id" ValueType="System.Int32" TextField="Denumire" >
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="btnSaveCond" runat="server" OnClick="btnSaveCond_Click" Width="30px">
                                                <Image Url="~/Fisiere/Imagini/Icoane/salveaza.png"></Image>
                                            </dx:ASPxButton>
                                        </td>
                                    </tr>
                                ...
                                <asp:UpdatePanel ID="up4" runat="server" OnUnload="up4_Unload">
                                    <ContentTemplate>

                                        <dx:ASPxGridView ID="grDateCond" runat="server" ClientInstanceName="grDateCond" Width="100%" AutoGenerateColumns="false" OnRowDeleting="grDateCond_RowDeleting" OnRowUpdating="grDateCond_RowUpdating" >
                                            <SettingsBehavior AllowFocusedRow="true" />
                                            <Settings ShowFilterRow="False" ShowGroupPanel="False" ShowColumnHeaders="false" />
                                            <SettingsSearchPanel Visible="False" />
                                            <Columns>
                                                ...
                                                <dx:GridViewCommandColumn Width="24px" ShowDeleteButton="true" ShowEditButton="true" ButtonType="Image" Caption=" " >
                                    ...
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="btnSaveCond" EventName="Click" />
                                    </Triggers>
                                </asp:UpdatePanel>
