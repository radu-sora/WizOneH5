...
namespace WizOne
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = General.IncarcaDT(
             $@"SELECT 1 AS ID, '2019-07-22 10:00:00.000' AS StartTime, '2019-07-22 11:00:00.000' AS EndTime, 'Programare I' AS Subject
                UNION
                SELECT 2 AS ID, '2019-07-22 13:00:00.000' AS StartTime, '2019-07-22 14:00:00.000' AS EndTime, 'Programare II' AS Subject
                UNION
                SELECT 3 AS ID, '2019-07-22 16:00:00.000' AS StartTime, '2019-07-22 17:30:00.000' AS EndTime, 'Programare III' AS Subject
                ", null);
