        ...
        <PanelCollection>
            <dx:PanelContent>
                ...
                <div class="Absente_divOuter margin_top15">
                    ...
                    <div style="float:left; padding-right:15px;">    
                        <dx:ASPxComboBox ID="cmbSupFunc" runat="server" Width="300px" ValueField="Id" TextField="Denumire" ValueType="System.Int32" AutoPostBack="false" AllowNull="true" 
                                    IncrementalFilteringMode="Contains" CallbackPageSize="15" EnableCallbackMode="true" TextFormatString="{0} {1}"  >
                            <Columns>
                                <dx:ListBoxColumn FieldName="Id" Caption="Id" Width="130px" />
                                <dx:ListBoxColumn FieldName="Denumire" Caption="Post" Width="130px" />
                ...
                <div class="Absente_divOuter margin_top15">
                    ...
                    <div style="float:left; padding-right:15px;">
                        <dx:ASPxComboBox ID="cmbHay" ClientInstanceName="cmbHay" runat="server" Width="100px" ValueField="Id" TextField="Id" ValueType="System.Int32" AutoPostBack="false" AllowNull="true" oncontextMenu="ctx(this,event)"
		            ...
		            <label id="lblSalMin" runat="server" style="display:inline-block; float:left; padding-right:15px; width:100px;">Salariul min</label>
                    <div style="float:left; padding-right:15px;">
                        <dx:ASPxSpinEdit ID="txtSalMin" ClientInstanceName="txtSalMin" runat="server" Width="100px" DecimalPlaces="0" />
                    </div>        
		            <label id="lblSalMed" runat="server" style="display:inline-block; float:left; padding-right:15px;">median</label>
                    <div style="float:left; padding-right:15px;">
                        <dx:ASPxSpinEdit ID="txtSalMed" ClientInstanceName="txtSalMed" runat="server" Width="100px" DecimalPlaces="0" />
                    </div>        
		            <label id="lblSalMax" runat="server" style="display:inline-block; float:left; padding-right:15px;">max</label>
                    <div style="float:left; padding-right:15px;">
                        <dx:ASPxSpinEdit ID="txtSalMax" ClientInstanceName="txtSalMax" runat="server" Width="100px" DecimalPlaces="0" MaxLength="6" />
                    </div>
                </div>
                ...
                <div class="Absente_divOuter margin_top15">
                    ...
                    <div style="float:left; padding-right:15px;">    
                        <dx:ASPxComboBox ID="cmbCor" runat="server" Width="300px" ValueField="F72202" TextField="F72204" ValueType="System.Int32" AutoPostBack="false" AllowNull="true" IncrementalFilteringMode="Contains"
                    ...
                    <div style="float:left; padding-right:15px;">
                        <dx:ASPxTextBox ID="txtNivelIer" runat="server" Width="100px" ClientEnabled="false"/>
                    ...
                    <div style="float:left; padding-right:15px;">
                        <dx:ASPxTextBox ID="txtPlan" runat="server" Width="100px"/>
                    </div>
                </div>
