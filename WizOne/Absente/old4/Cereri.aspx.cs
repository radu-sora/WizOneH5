...
namespace WizOne.Absente
{
    public partial class Cereri : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                switch (dtRol.Rows.Count)
                {
                    ...
                    default:
                        ...
                        cmbRol.DataBind();
                        cmbRol.SelectedIndex = 0;
                        //cmbAng.GridView.Selection.SetSelection(0,true);
                        break;
                }
                ...
                cmbAng.GridView.AutoFilterCellEditorInitialize += cmbAng_AutoFilterCellEditorInitialize;


                //var ert = cmbAng.GridView.;
                ...
                if (!IsPostBack)
                {
                    ...
                    cmbAng.GridView.AutoFilterByColumn(cmbAng.Columns["AngajatActiv"], "1");
                }
                var ert = cmbAng.GridView.FilterExpression;
        ...
        protected void cmbAng_AutoFilterCellEditorInitialize(object sender, DevExpress.Web.ASPxGridViewEditorEventArgs e)
        {
            try
            {
                ...
                if (cmb != null)
                {
                    ...
                    if (chk != null)
                    {
                        ...
                        cmb.Items.Add(Dami.TraduCuvant("Activ"), chk.PropertiesCheckEdit.ValueChecked);
                        cmb.Items.Add(Dami.TraduCuvant("Inactiv"), chk.PropertiesCheckEdit.ValueUnchecked);
                    }
                }
            }
            catch (Exception ex)
