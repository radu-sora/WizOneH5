...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <td colspan="2" style="margin-top:15px;">
                ...
                <dx:ASPxGridView ID="grDate" runat="server" ClientInstanceName="grDate" ClientIDMode="Static" Width="100%" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="ModifInOut" ReadOnly="true" Visible="false" ShowInCustomizationForm="false" />
                    </Columns>                 
                </dx:ASPxGridView>
            </td>
        </tr>
    ...
    <div style="display:inline-block; width:100%; position:relative;">
        <div id="divGrid" style="position:absolute; z-index:100; width:100%; height:100%; display:none; background-color:#fafafa; opacity:0.2;"></div>
