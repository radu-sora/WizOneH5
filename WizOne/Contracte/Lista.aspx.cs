                        ...
                        case "btnDuplica":
                            {
                                General.ExecutaNonQuery(
                                    $@"BEGIN
                                        ...
                                        INSERT INTO ""Ptj_Contracte""(""Id"", ""Denumire"", ""DenumireInAdmin"", ""OraInSchimbare"", ""OraOutSchimbare"", ""TipSchimb0"", ""Program0"", ""TipSchimb1"", ""Program1"", ""TipSchimb2"", ""Program2"", ""TipSchimb3"", ""Program3"",""TipSchimb4"", ""Program4"", ""TipSchimb5"", ""Program5"", ""TipSchimb6"", ""Program6"", ""TipSchimb7"", ""Program7"", ""TipSchimb8"", ""Program8"", ""OreSup"", ""Afisare"", ""TipRaportareOreNoapte"", ""PontareAutomata"", ""OraInInitializare"", ""OraOutInitializare"", USER_NO, TIME)
                                        SELECT COALESCE((SELECT MAX(""Id"") FROM ""Ptj_Contracte""),0) + 1, ""Denumire"" {Dami.Operator()} ' - Copie', ""DenumireInAdmin"" {Dami.Operator()} ' - Copie', ""OraInSchimbare"", ""OraOutSchimbare"", ""TipSchimb0"", ""Program0"", ""TipSchimb1"", ""Program1"", ""TipSchimb2"", ""Program2"", ""TipSchimb3"", ""Program3"",""TipSchimb4"", ""Program4"", ""TipSchimb5"", ""Program5"", ""TipSchimb6"", ""Program6"", ""TipSchimb7"", ""Program7"", ""TipSchimb8"", ""Program8"", ""OreSup"", ""Afisare"", ""TipRaportareOreNoapte"", ""PontareAutomata"", ""OraInInitializare"", ""OraOutInitializare"", {Session["UserId"]}, {General.CurrentDate()} FROM ""Ptj_Contracte"" WHERE ""Id""=@1;
