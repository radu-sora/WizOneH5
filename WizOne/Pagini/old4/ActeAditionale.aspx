        ...
        <tr>
            <td colspan="2">
                <div style="display:inline-block; line-height:22px; vertical-align:middle; padding:15px 0px 15px 0px;">
                    <label id="lblTip" runat="server" style="display:inline-block; float:left; padding-right:15px;">Tip</label>
                    <div style="float:left; padding-right:15px;">
                        <dx:ASPxComboBox ID="cmbTip" ClientInstanceName="cmbTip" ClientIDMode="Static" runat="server" Width="150px" AutoPostBack="false" >
                            <Items>
...
                                <dx:ListEditItem Text="Candidat" Value="1" />
                    ...
                    <label id="lblAng" runat="server" style="display:inline-block; float:left; padding-right:15px;">Angajat/Candidat</label>
                    <div style="float:left; padding-right:15px;">
                    ...
                    <label id="lblStatus" runat="server" style="display:inline-block; float:left; padding-right:15px;">Status</label>
                    <div style="float:left; padding-right:15px;">
                        <dx:ASPxComboBox ID="cmbStatus" ClientInstanceName="cmbStatus" ClientIDMode="Static" runat="server" Width="150px" ValueField="Id" TextField="Denumire" ValueType="System.Int32" AutoPostBack="false" >
                            <Items>
                                <dx:ListEditItem Text="Aprobat" Value="1" />
                                <dx:ListEditItem Text="Numar atribuit" Value="2" />
                                <dx:ListEditItem Text="Tiparit" Value="3" />
                                <dx:ListEditItem Text="Semnat" Value="4" />
                                <dx:ListEditItem Text="Trimis in Revisal" Value="5" />
                                <dx:ListEditItem Text="Anulat" Value="6" />
                            </Items>
                        </dx:ASPxComboBox>
                    </div>

                    <label id="lblData" runat="server" style="display:inline-block; float:left; padding-right:15px;">Data modificarii</label>
                    <div style="float:left; padding-right:15px;">
                        <dx:ASPxDateEdit ID="txtData" runat="server" Width="100px" DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy" EditFormat="Custom" >
            ...
            <td colspan="2">
                ...
                <dx:ASPxGridView ID="grDate" runat="server" ClientInstanceName="grDate" ClientIDMode="Static" Width="100%" AutoGenerateColumns="false" OnCustomCallback="grDate_CustomCallback" OnRowUpdating="grDate_RowUpdating" OnAutoFilterCellEditorInitialize="grDate_AutoFilterCellEditorInitialize" OnHtmlRowCreated="grDate_HtmlRowCreated" >
                    ...
                    <Columns>
                        ...
                        <dx:GridViewCommandColumn Width="30px" VisibleIndex="1" ButtonType="Image" ShowEditButton="true" Caption=" " Name="butoaneGrid" />
                        ...
                        <dx:GridViewBandColumn Caption="Atasamente" HeaderStyle-HorizontalAlign="Center" Name="colAtas">
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Width="100px" Caption="Incarca" CellStyle-HorizontalAlign="Center">
                                    <DataItemTemplate>
                                        <dx:ASPxUploadControl ID="btnDocUpload" runat="server" ShowProgressPanel="true" Height="28px"
                                            ...
                                            <ClientSideEvents FileUploadComplete="function(s,e) { grDate.PerformCallback('btnDocUpload; '); }" />
                                ...
                                <dx:GridViewDataTextColumn Width="100px" Caption="Vizualizare" CellStyle-HorizontalAlign="Center" Name="colArata">
                                    <DataItemTemplate>
                                        <dx:ASPxButton ID="btnArata" ClientInstanceName="btnArata" ClientIDMode="Static" runat="server" Text="" AutoPostBack="false" ToolTip="Arata document" oncontextMenu="ctx(this,event)" >
                                            <Image Url="~/Fisiere/Imagini/Icoane/arata.png"></Image>
                                            <ClientSideEvents Click="ArataAtas" />
                                        </dx:ASPxButton>
                                    </DataItemTemplate>
                                </dx:GridViewDataTextColumn>
                                ...
                                <dx:GridViewDataColumn Width="100px" Caption="Stergere" CellStyle-HorizontalAlign="Center" Name="colSterge">
                                    <DataItemTemplate>
                                        <dx:ASPxButton ID="btnSterge" ClientInstanceName="btnSterge" ClientIDMode="Static" runat="server" Text="" AutoPostBack="false" ToolTip="Sterge document" oncontextMenu="ctx(this,event)" >
