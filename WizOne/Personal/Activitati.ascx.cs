...
namespace WizOne.Personal
{
    public partial class Activitati : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (General.VarSession("EsteAdmin").ToString() == "0") Dami.Securitate(grDateActivitati);
        }
        ...
        private void IncarcaGrid()
        {
            ...
            string sqlFinal = "SELECT * FROM \"Admin_Activitati\" WHERE \"Marca\" = " + Session["Marca"].ToString();
