<%@ Page Title="" Language="C#" MasterPageFile="~/Cadru.Master" AutoEventWireup="true" CodeBehind="Test.aspx.cs" Inherits="WizOne.Personal.Test" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dx:ASPxPageControl SkinID="None" Width="100%" EnableViewState="false" ID="tabMain" EnableTabScrolling="true"
        runat="server" ActiveTabIndex="0" TabSpacing="0px" CssClass="pcTemplates"
        EnableHierarchyRecreation="True" >
        <TabPages>

            <dx:TabPage Text="Date Identificare" Name="tabIdentificare" >
                <dx:ContentCollection>
            ...
            <dx:TabPage Text="Date Ident" Name="tabiden" >
                <ContentCollection>
                    <dx:ContentControl runat="server">
...
<div class="row">
    <div class="col-lg-6">
        <dx:ASPxLabel Text="Marca" runat="server"></dx:ASPxLabel>
    </div>
    <div class="col-lg-6">
        <dx:ASPxTextBox ID="ctl_F10003" runat="server"></dx:ASPxTextBox>
    </div>
</div>
			          <fieldset class="fieldset-auto-width">
