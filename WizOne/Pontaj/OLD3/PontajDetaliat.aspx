                    ...
                    <PanelCollection>
                        <dx:PanelContent>
                            ...
                            <div id="divPeAng" runat="server" style="float:left; display:none; line-height:22px; vertical-align:middle;">
                                ...
                                <label ID="txtStare" runat="server" Width="110" style="float:left; margin-right:15px; width:110px; height:26px; text-align:center; border:solid 1px gray; color:white;"></label>
                            </div>
        ...
        <tr>
            <td colspan="2">
                ...
                <dx:ASPxGridView ID="grDate" runat="server" ClientInstanceName="grDate" ClientIDMode="Static" Width="100%" AutoGenerateColumns="false" OnCustomCallback="grDate_CustomCallback" OnHtmlDataCellPrepared="grDate_HtmlDataCellPrepared" OnHtmlRowPrepared="grDate_HtmlRowPrepared" OnBatchUpdate="grDate_BatchUpdate" OnDataBound="grDate_DataBound" OnCellEditorInitialize="grDate_CellEditorInitialize" >
                    ...
                    <Styles>
                        <BatchEditModifiedCell BackColor="#e6c8fa">
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ...
                            <dx:ASPxCallbackPanel ID="pnlCC" ClientIDMode="Static" ClientInstanceName="pnlCC" runat="server" SettingsLoadingPanel-Enabled="false" OnCallback="pnlCC_Callback" >
                                <PanelCollection>
                                    <dx:PanelContent>


                                        <dx:ASPxGridView ID="grCC" runat="server" ClientInstanceName="grCC" ClientIDMode="Static" AutoGenerateColumns="false" Visible="false" OnRowInserting="grCC_RowInserting" OnRowUpdating="grCC_RowUpdating" OnInitNewRow="grCC_InitNewRow" >
                                            <SettingsBehavior AllowSelectByRowClick="true" AllowFocusedRow="true" AllowSelectSingleRowOnly="false" EnableCustomizationWindow="true" ColumnResizeMode="Control" />
                                            <Settings ShowFilterRow="False" ShowGroupPanel="False" HorizontalScrollBarMode="Auto" ShowStatusBar="Hidden" VerticalScrollBarMode="Visible" VerticalScrollBarStyle="VirtualSmooth" />
                                            <SettingsEditing Mode="Inline" />
                                            <SettingsSearchPanel Visible="false" />
                                            <SettingsLoadingPanel Mode="ShowAsPopup" />
                                            <ClientSideEvents ContextMenu="ctx" EndCallback="function (s,e) { alert('asd'); pnlLoading.Hide(); }" CallbackError="function (s,e) { pnlLoading.Hide(); }" BeginCallback="function (s,e) { pnlLoading.Show(); }" />

                                            <Columns>
                                                <dx:GridViewCommandColumn Width="80px" ShowDeleteButton="true" ShowEditButton="true" VisibleIndex="0" ButtonType="Image" Caption=" " />
                        
                                                <dx:GridViewDataComboBoxColumn FieldName="F06204" Name="F06204" Caption="Centrul de cost" Width="250px" VisibleIndex="1">
                                                    <PropertiesComboBox TextField="F06205" ValueField="F06204" ValueType="System.Int32" DropDownStyle="DropDown" />
                                                </dx:GridViewDataComboBoxColumn>
                                                <dx:GridViewDataComboBoxColumn FieldName="IdProiect" Name="IdProiect" Caption="Proiect" Width="250px" VisibleIndex="2">
                                                    <PropertiesComboBox TextField="Denumire" ValueField="Id" ValueType="System.Int32" DropDownStyle="DropDown" />
                                                </dx:GridViewDataComboBoxColumn>
                                                <dx:GridViewDataTimeEditColumn FieldName="De" Name="De" Caption="De" Width="100px" VisibleIndex="3" >
                                                ...
                                                <dx:GridViewDataTimeEditColumn FieldName="La" Name="La" Caption="La" Width="100px" VisibleIndex="4" >
                                                    <PropertiesTimeEdit DisplayFormatInEditMode="true" DisplayFormatString="HH:mm" EditFormat="DateTime" EditFormatString="HH:mm" />
                                                </dx:GridViewDataTimeEditColumn>
