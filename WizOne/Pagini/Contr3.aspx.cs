...
{
    public partial class Contr3 : System.Web.UI.Page
    {
        //int F10003 = -99;
        ...
        private void IncarcaGrid()
        {
            ...
            GridViewDataComboBoxColumn colCtr = (grDateSupervizori.Columns["IdContract"] as GridViewDataComboBoxColumn);
            ...
            try
            {
                ...
                if (e.NewValues["DataInceput"] != null && e.NewValues["DataSfarsit"] != null)
                {
                    try
                    {
                        ...
                        {
                            grDateSupervizori.JSProperties["cpAlertMessage"] = "Data inceput mai mare decat data sfarsit!";
                            e.Cancel = true;
                            grDateSupervizori.CancelEdit();
                            return;
                        }
                ...
                if (e.NewValues["DataInceput"] == null || e.NewValues["DataSfarsit"] == null)
                {
                    grDateSupervizori.JSProperties["cpAlertMessage"] = "Nu ati completat " + (e.NewValues["DataInceput"] == null ? "data inceput" : "data sfarsit") + "!";
                    e.Cancel = true;
                    grDateSupervizori.CancelEdit();
                    return;
                }
                ...
                e.Cancel = true;
                grDateSupervizori.CancelEdit();
                grDateSupervizori.DataSource = ds.Tables["F100Contracte2"];
                grDateSupervizori.KeyFieldName = "IdAuto";
