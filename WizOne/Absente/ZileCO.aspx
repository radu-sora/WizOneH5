<%@ Page Title="" Language="C#" MasterPageFile="~/Cadru.Master" AutoEventWireup="true" CodeBehind="ZileCO.aspx.cs" Inherits="WizOne.Absente.ZileCO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td align="right">
                        <dx:ASPxButton ID="btnCO" ClientInstanceName="btnCO" ClientIDMode="Static" runat="server" Text="Calcul CO" AutoPostBack="false" oncontextMenu="ctx(this,event)" >
                            <ClientSideEvents Click="function (s, e) { GoToCalculationMode(s, e); }" />
                            <Image Url="~/Fisiere/Imagini/Icoane/calcul.png"></Image>
                        </dx:ASPxButton>
                        <dx:ASPxButton ID="btnSI" ClientInstanceName="btnSI" ClientIDMode="Static" runat="server" Text="Calcul SI" AutoPostBack="False" oncontextMenu="ctx(this,event)" >
                            <ClientSideEvents Click="function (s, e) { GoToCalculationMode(s, e); }" />
                            <Image Url="~/Fisiere/Imagini/Icoane/calcul.png"></Image>
                        </dx:ASPxButton>
                        <dx:ASPxButton ID="btnNew" ClientInstanceName="btnNew" ClientIDMode="Static" runat="server" Text="Nou" Visible="false" AutoPostBack="False" oncontextMenu="ctx(this,event)" >
