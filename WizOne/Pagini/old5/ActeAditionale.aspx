...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%">
        <tr>
            ...
            <td align="right">
                <dx:ASPxButton ID="btnUnire" ClientInstanceName="btnUnire" ClientIDMode="Static" runat="server" Text="Unire" AutoPostBack="false" oncontextMenu="ctx(this,event)" Visible="false" >
...
                                <dx:ListEditItem Text="Candidat" Value="1" />
                    ...
                    <label id="lblDepasire" runat="server" style="display:inline-block; float:left; padding-right:15px;">Depasire Revisal</label>
                    <div style="float:left; padding-right:15px;">
            ...
            <td colspan="2">
                ...
                <dx:ASPxGridView ID="grDate" runat="server" ClientInstanceName="grDate" ClientIDMode="Static" Width="100%" AutoGenerateColumns="false" OnCustomCallback="grDate_CustomCallback" OnRowUpdating="grDate_RowUpdating" OnAutoFilterCellEditorInitialize="grDate_AutoFilterCellEditorInitialize" OnHtmlRowCreated="grDate_HtmlRowCreated" >
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataDateColumn FieldName="TermenDepasire" Name="TermenDepasire" Caption="Termen depasire" ReadOnly="true" Width="100px" >
                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                        </dx:GridViewDataDateColumn>
