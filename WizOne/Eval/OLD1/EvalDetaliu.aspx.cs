...
namespace WizOne.Eval
{
    public partial class EvalDetaliu : System.Web.UI.Page
    {
        ...
        {
            //string log = "IdClient - " + _idClient + Environment.NewLine;
            //log += "IdQuiz - " + Session["CompletareChestionar_IdQuiz"] + Environment.NewLine;
            //log += "F10003 - " + Session["CompletareChestionar_F10003"] + Environment.NewLine;

            try
            {
                idCateg = General.Nz(General.ExecutaScalar(@"SELECT ""CategorieQuiz"" FROM ""Eval_Quiz"" WHERE ""Id""=" + Session["CompletareChestionar_IdQuiz"], null), "0").ToString();

                lblEvaluat.InnerText = Dami.TraduCuvant("Evaluat") + ":" + Session["CompletareChestionar_Nume"].ToString();

                if (!IsPostBack)
                {
                    //Begin Florin 2019.01.21
                    DataTable tableAAA = General.IncarcaDT(@"select * from ""Eval_Raspuns"" where ""IdAuto"" = " + General.Nz(Session["IdEvalRaspuns"],-99), null);
                    tableAAA.TableName = "Eval_Raspuns";

                    DataTable tableBBB = General.IncarcaDT(@"select * from ""Eval_RaspunsLinii"" where ""IdQuiz"" = " + General.Nz(Session["CompletareChestionar_IdQuiz"],-99) + @" and ""F10003"" = " + General.Nz(Session["CompletareChestionar_F10003"], -99), null);
                    tableBBB.TableName = "Eval_RaspunsLinii";

                    DataTable tableCCC = General.IncarcaDT(@"select * from ""Eval_QuizIntrebari"" where ""IdQuiz"" = " + General.Nz(Session["CompletareChestionar_IdQuiz"], -99), null);
                    ...
                    DataTable dtQuiz = General.IncarcaDT(sql, null);
                    if (dtQuiz.Rows[0]["LuatLaCunostinta"] != null && dtQuiz.Rows[0]["LuatLaCunostinta"].ToString().Length > 0 && dtQuiz.Rows[0]["LuatLaCunostinta"].ToString() != "0")
                    {
                        ...
                        DataTable dtRaspIst = General.IncarcaDT(sql, null);
                    ...
                    if (raspLinie != null)
                    {
                        if (Convert.ToInt32(_idClient) == 20)
                        {
                            if (raspLinie.TipData == 3 && raspLinie.TipValoare == 8)
                            {
                                ...
                                DataTable dtVal = General.IncarcaDT(sql, null);
        ...
        private ASPxGridView CreeazaObiectiveIndividuale(int id, int idGrupValori, string super)
        {
            ...
            try
            {
                ...
                if (Session["lstEval_ConfigObTemplate"] == null)
                {
                    ...
                    DataTable dtEval_ConfigObTemplate = General.IncarcaDT(sqlConfigObTemplate, null);
                ...
                if (Session["lstEval_ConfigObTemplateDetail"] == null)
                {
                    ...
                    DataTable dtEval_ConfigObTemplateDetail = General.IncarcaDT(sqlConfigObTemplateDetail, null);
                        ...
                        if (clsConfigDetail.ColumnName == "Obiectiv")
                        {
                            if (clsConfigDetail.TipValoare == 1)
                            {
                                ...
                                if (Session["feedEval_Obiectiv"] == null)
                                {
                                    ...
                                    DataTable dtObiectiv = General.IncarcaDT(strSQLObiectiv, null);
                                ...
                                if (Session["feedEval_ObiectivActivitate"] == null)
                                {
                                    ...
                                    DataTable dtObiectivActivitate = General.IncarcaDT(strSQLObiectivActivitate, null);
                                    lstActivitati.Clear();
                        ...
                        if (clsConfigDetail.ColumnName == "Calificativ")
                        {
                            ...
                            if (clsConfigDetail.TipValoare == 1)
                            {
                                ...
                                if (Session["feedEval_Calificativ"] == null)
                                {
                                    ...
                                    DataTable dtCalificativ = General.IncarcaDT(sqlCalificativ, null);
        ...
        private ASPxGridView CreeazaCompetenteAngajat(int id, int idGrupValori, string super)
        {
            ...
            try
            {
                ...
                if (Session["lstEval_ConfigCompTemplate"] == null)
                {
                    ...
                    DataTable dtEval_ConfigCompTemplate = General.IncarcaDT(sqlConfigCompTemplate, null);
                ...
                if (Session["lstEval_ConfigCompTemplateDetail"] == null)
                {
                    ...
                    DataTable dtEval_ConfigCompTemplateDetail = General.IncarcaDT(sqlConfigCompTemplateDetail, null);
                ...
                if (Session["lstEval_ConfigCompetente"] == null)
                {
                    ...
                    DataTable dtConfigCompetente = General.IncarcaDT(sqlConfigCompetente, null);
                        ...
                        if (clsConfigDetail.ColumnName == "Competenta")
                        {
                            ...
                            if (Session["feedEval_Competenta"] == null)
                            {
                                string strSQLCompetenta = @"
                                                            ...
                                                            where categ.""IdCategorie"" = {0}
                                                            and setAngDetail.""Id"" = {1}
        ...
        public string QuizAproba(int idQuiz, int f10003, int idUser)
        {
            ...
            try
            {
                ...
                DataTable entQz = General.IncarcaDT(sql, null);
                ...
                DataTable lstIst = General.IncarcaDT(sql, null);
                sql = "SELECT * FROM \"Eval_RaspunsIstoric\" a WHERE \"IdQuiz\" = " + idQuiz + " AND F10003 = " + f10003 + " AND (\"Aprobat\" IS NULL OR \"Aprobat\" = 0) "  
                    ...
                    + f10003 + " AND b.\"IdSuper\" = (-1) * a.\"IdSuper\")))  ORDER BY \"Pozitie\"";
                DataTable entIst = General.IncarcaDT(sql, null);       
                ...
                DataTable entCir = General.IncarcaDT(sql, null);
                ...
                DataTable entPoz = General.IncarcaDT(sql, null);
                ...
                DataTable entDtFin = General.IncarcaDT(sql, null);
                if (entDtFin != null && entDtFin.Rows.Count > 0)
                {
                    sql = "UPDATE \"Eval_RaspunsLinii\" SET ";
                    for (int i = 1; i <= 20; i++)
                    {                        
                    ...
                    sql += "WHERE \"IdQuiz\" = " + idQuiz + " AND F10003 = " + f10003 + " AND \"TipData\" = 36";
                ...
                if (ent.Rows[0]["Finalizat"].ToString() != "1")
                {
                    ...
                    DataTable dtObiective = General.IncarcaDT(sql, null);
                ...
                if (ent.Rows[0]["Finalizat"].ToString() != "1")
                {
                    ...
                    DataTable dtCompetente = General.IncarcaDT(sql, null);
                    ...
                    if (dtCompetente != null && dtCompetente.Rows.Count > 0)
                    {
                        for (int i = 0; i < dtCompetente.Rows.Count; i++)
                        {
                            ...
                            sql = "INSERT INTO \"Eval_CompetenteAngajatTemp\" (\"IdCategCompetenta\", \"CategCompetenta\", \"IdCompetenta\", \"Competenta\", \"ExplicatiiCalificativ\", \"IdQuiz\", F10003,  \"Pozitie\", \"IdLinieQuiz\") "
                    ...
                    { 
                        ...
                        if (dt != null && dt.Rows.Count > 0)
                        {
                            for (int j = 0; j < dt.Rows.Count; j++)
                            {
                                ...
                                int cnt = Convert.ToInt32(General.Nz(General.ExecutaScalar(strCnt, null),0));
        ...
        private int DamiIdObi()
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    exista = Convert.ToInt32(General.Nz(General.ExecutaScalar("SELECT COUNT(*) FROM Eval_ObiIndividualeTemp WHERE IdAuto=" + id, null), 1));
                }
                while (exista == 1);
            }
            catch (Exception ex)
