                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ...
                            <dx:ASPxGridView ID="grCC" runat="server" ClientInstanceName="grCC" ClientIDMode="Static" AutoGenerateColumns="false" Visible="false" OnRowInserting="grCC_RowInserting" 
                                OnRowUpdating="grCC_RowUpdating" OnInitNewRow="grCC_InitNewRow" OnCustomCallback="grCC_CustomCallback" OnRowDeleting="grCC_RowDeleting" 
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataComboBoxColumn FieldName="IdProiect" Name="IdProiect" Caption="Proiect" Width="250px" VisibleIndex="3" Visible="false">
                                        <PropertiesComboBox TextField="Denumire" ValueField="Id" ValueType="System.Int32" DropDownStyle="DropDown" />
                                        <EditItemTemplate>
                                                <dxe:ASPxComboBox ID="cmbPro" runat="server" TextField="Denumire" ValueField="Id" AutoPostBack="true" ValueType="System.Int32" OnSelectedIndexChanged="cmbPro_SelectedIndexChanged" />
                                        </EditItemTemplate>
                                    </dx:GridViewDataComboBoxColumn>
                                    <dx:GridViewDataComboBoxColumn FieldName="IdSubproiect" Name="IdSubproiect" Caption="SubProiect" Width="250px" VisibleIndex="4" Visible="false">
                                        <PropertiesComboBox TextField="Denumire" ValueField="Id" ValueType="System.Int32" DropDownStyle="DropDown" />
                                        <EditItemTemplate>
                                                <dxe:ASPxComboBox ID="cmbSub" runat="server" TextField="Denumire" ValueField="Id" AutoPostBack="true" ValueType="System.Int32" OnSelectedIndexChanged="cmbSub_SelectedIndexChanged" />
                                        </EditItemTemplate>
                                    </dx:GridViewDataComboBoxColumn>
                                    <dx:GridViewDataComboBoxColumn FieldName="IdActivitate" Name="IdActivitate" Caption="Activitate" Width="250px" VisibleIndex="5" Visible="false">
                                        <PropertiesComboBox TextField="Denumire" ValueField="Id" ValueType="System.Int32" DropDownStyle="DropDown" />
                                        <EditItemTemplate>
                                                <dxe:ASPxComboBox ID="cmbAct" runat="server" TextField="Denumire" ValueField="Id" AutoPostBack="true" ValueType="System.Int32" OnSelectedIndexChanged="cmbAct_SelectedIndexChanged" />
                                        </EditItemTemplate>
                                    </dx:GridViewDataComboBoxColumn>
                                    ...
                                    <dx:GridViewDataTimeEditColumn FieldName="De" Name="De" Caption="De" Width="100px" VisibleIndex="7" Visible="false" >
                                        <PropertiesTimeEdit DisplayFormatInEditMode="true" DisplayFormatString="HH:mm" EditFormat="DateTime" EditFormatString="HH:mm">
                                            <ClientSideEvents ValueChanged ="function(s,e) { OnDateModif(); }" />
                                        </PropertiesTimeEdit>
