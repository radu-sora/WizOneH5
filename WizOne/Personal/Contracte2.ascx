<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Contracte2.ascx.cs" Inherits="WizOne.Personal.Contracte2" %>

<script type="text/javascript">  

 
    function OnEndCallbackContracte2(s, e) {
...
<body>
    ...
    <dx:ASPxGridView ID="grDateContracte2" runat="server" ClientInstanceName="grDateContracte2" ClientIDMode="Static" AutoGenerateColumns="false" Width="800px"  OnDataBinding="grDateContracte2_DataBinding" OnInitNewRow="grDateContracte2_InitNewRow"
        OnRowInserting="grDateContracte2_RowInserting" OnRowUpdating="grDateContracte2_RowUpdating" OnRowDeleting="grDateContracte2_RowDeleting" OnCommandButtonInitialize="grDateContracte2_CommandButtonInitialize">
        <SettingsBehavior AllowFocusedRow="true" />
        <Settings ShowFilterRow="False" ShowColumnHeaders="true"  />   
        <ClientSideEvents CustomButtonClick="function(s, e) { grDateContracte2_CustomButtonClick(s, e); }" ContextMenu="ctx" EndCallback="OnEndCallbackContracte2"/> 
