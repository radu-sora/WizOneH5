                        ...
                        case "btnDelete":
                            {
                                ...
                                //parametrul   StareCererePentruAnulat   este inlocuit de     AnulareCerere_Stari
                                //if (Dami.ValoareParam("StareCererePentruAnulat").IndexOf(idStare.ToString()) < 0)
                                //{
                                //    grDate.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Nu puteti anula o cerere in aceasta stare");
                                //    //MessageBox.Show(Dami.TraduCuvant("Nu puteti anula o cerere in aceasta stare"), MessageBox.icoWarning, "Atentie !");
                                //    return;
                                //}


                                //valabil pentru nootificari
                                //tip = 1  vine din solicitari cereri
                                //tip = 2  vine din aprobare si aprobare HR

                                //tip = 4  - stergere   //Radu 10.05.2016


                                //int idStareCumulat = 1;
                                //DataRow drCum = General.IncarcaDR(@"SELECT * FROM ""Ptj_Cumulat"" WHERE F10003=@1 AND ""An""=@2 AND ""Luna""=@3", new object[] { obj[1], Convert.ToDateTime(obj[4]).Date.Year, Convert.ToDateTime(obj[4]).Date.Month });
                                ...
                                //try
                                //{
                                //    DataRow drParam = GetDataAnulare(Convert.ToInt32(Session["UserId"] ?? -99), Convert.ToInt32(obj[1]), 0, -99);
                                //    if (drParam != null)
                                //    {
                                ...
                                //            case "7":
                                //                {
                                //                    switch(idStareCumulat)
                                //                    {
                                //                        case 2:
                                //                        case 3:
                                //                        case 5:
                                //                        case 7:
                                //                            grDate.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Nu se permit modificari!\nPontajul a fost aprobat sau finalizat");
                                //                            //MessageBox.Show(Dami.TraduCuvant("Nu se permit modificari!\nPontajul a fost aprobat sau finalizat"), MessageBox.icoWarning);
                                //                            return;
                                //                    }
                                //                }
                                //                break;
                                //            default:
                                //                if (Convert.ToDateTime(obj[4]).Date < Convert.ToDateTime(drParam["Valoare"]).Date)
                                //                {
                                //                    grDate.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Data inceput trebuie sa fie mai mare sau egala decat") + " " + Convert.ToDateTime(drParam["Valoare"]).Date.ToShortDateString();
                                ...
                                //stergem din pontaj
                                //if (entAbs.IdTipOre == 0 && entAbs.OreInVal
                                int idTipOre = 0;
                                string oreInVal = "";
                                if (drAbs != null)
                                {
                                ...
                                //{
                                //    case 1:
                                //        ctxNtf.ValidareRegula("Absente.Cereri", "grDate", ent, idUser, (ent.F10003 ?? -99), out corpMesaj, out stop);
                                //        break;
                                //    case 2:
                                //        ctxNtf.ValidareRegula("Absente.Aprobare", "grDate", ent, idUser, (ent.F10003 ?? -99), out corpMesaj, out stop);
                                //        break;
                                //    case 3:
                                //        ctxNtf.ValidareRegula("Absente.AprobareHR", "grDate", ent, idUser, (ent.F10003 ?? -99), out corpMesaj, out stop);
                                //        break;
                                //    case 4:     //pt stergere nu mai trebuie validate reguli    //Radu 10.05.2016
                                //        break;
                                //}
                                ...
                                //if (tip == 1 || tip == 4)       //Radu 11.07.2016 - si pentru anulari trebuie sa se trimita pagina 'Cereri'
                                //    ctxNtf.TrimiteNotificare("Absente.Cereri", "grDate", ent, idUser, (ent.F10003 ?? -99));
                                //else
                                //    ctxNtf.TrimiteNotificare("Absente.Aprobare", "grDate", ent, idUser, (ent.F10003 ?? -99));
