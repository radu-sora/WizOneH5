...
namespace WizOne.Personal
{
    public partial class Test2 : System.Web.UI.UserControl
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            Test2_DataList.DataSource = table;
            Test2_DataList.DataBind();



            ASPxTextBox txtZile = Test2_DataList.Items[0].FindControl("txtNrZile") as ASPxTextBox;
            ASPxTextBox txtLuni = Test2_DataList.Items[0].FindControl("txtNrLuni") as ASPxTextBox;
            ASPxDateEdit deDeLa = Test2_DataList.Items[0].FindControl("deDeLaData") as ASPxDateEdit;
            ASPxDateEdit deLa = Test2_DataList.Items[0].FindControl("deLaData") as ASPxDateEdit;
            ASPxDateEdit deTermenRevisal = Test2_DataList.Items[0].FindControl("deTermenRevisal") as ASPxDateEdit;
            ...
            ASPxTextBox txtVechCompAni = Test2_DataList.Items[0].FindControl("txtVechCompAni") as ASPxTextBox;
            ASPxTextBox txtVechCompLuni = Test2_DataList.Items[0].FindControl("txtVechCompLuni") as ASPxTextBox;
            ASPxTextBox txtVechCarteMuncaAni = Test2_DataList.Items[0].FindControl("txtVechCarteMuncaAni") as ASPxTextBox;
            ASPxTextBox txtVechCarteMuncaLuni = Test2_DataList.Items[0].FindControl("txtVechCarteMuncaLuni") as ASPxTextBox;
            ...
            ASPxComboBox cmbCOR = Test2_DataList.Items[0].FindControl("cmbCOR") as ASPxComboBox;
            ...
            {
                ASPxLabel lbl = Test2_DataList.Items[0].FindControl(etichete[i]) as ASPxLabel;
            ...
            {
                ASPxCheckBox chk = Test2_DataList.Items[0].FindControl(bife[i]) as ASPxCheckBox;
            ...
            {
                ASPxButton btn = Test2_DataList.Items[0].FindControl(butoane[i]) as ASPxButton;
            ...
            {//DNATA
                ...
                {
                    ASPxTextBox txt = Test2_DataList.Items[0].FindControl(lstTextBox[i]) as ASPxTextBox;
                ...
                {
                    ASPxDateEdit de = Test2_DataList.Items[0].FindControl(lstDateEdit[i]) as ASPxDateEdit;
                ...
                {
                    ASPxComboBox cmb = Test2_DataList.Items[0].FindControl(lstComboBox[i]) as ASPxComboBox;
            ...
            General.SecuritatePersonal(Test2_DataList, Convert.ToInt32(Session["UserId"].ToString()));
        ...
        private void SetariNorma()
        {
            ...
            {
                ASPxComboBox cmbNorma = Test2_DataList.Items[0].FindControl("cmbNorma") as ASPxComboBox;
                ASPxComboBox cmbTimpPartial = Test2_DataList.Items[0].FindControl("cmbTimpPartial") as ASPxComboBox;
                ASPxTextBox txtNrOre = Test2_DataList.Items[0].FindControl("txtNrOre") as ASPxTextBox;
        ...
        protected void pnlCtlContract_Callback(object source, CallbackEventArgsBase e)
        {
            ...
            switch (param[0])
            {
                ...
                case "deDataCtrInt":
                    ...
                    {
                        Test2_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Data contract intern este intr-o zi nelucratoare!");
                    }
                ...
                case "deDataAng":
                    ...
                    if (Session["esteNou"] != null && Session["esteNou"].ToString().Length > 0 && Session["esteNou"].ToString() == "true")
                    {
                        ...
                        if (Convert.ToDateTime(deTermenRevisal.Value).Date < DateTime.Now.Date && val == 1)
                            Test2_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Termen depunere Revisal depasit!");
                    }
                    ...
                    {
                        Test2_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Data angajarii este intr-o zi nelucratoare!");
                    }
                ...
                case "cmbTimpPartial":
                    ...
                    {
                        Test2_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Timp partial invalid (max 6 pentru minori peste 16 ani)!");
                        SetariNorma();
                        return;
                    }
                ...
                case "cmbTipNorma":
                    ...
                    {
                        Test2_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Numar invalid de ore pe luna/saptamana (max 30 pentru minori peste 16 ani)!");
                        SetariNorma();
                        return;
                    }
                    ...
                    {
                        Test2_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Numar invalid de ore pe luna/saptamana (max 40 pentru norma intreaga)!");
                        return;
                    }
        ...
        private void cmbTipAngajat_SelectedIndexChanged(string F10043)
        {
            try
            {
                ASPxComboBox cmbTipAngajat = Test2_DataList.Items[0].FindControl("cmbTipAng") as ASPxComboBox;
                ASPxComboBox cmbTimpPartial = Test2_DataList.Items[0].FindControl("cmbTimpPartial") as ASPxComboBox;
                ASPxComboBox cmbTipNorma = Test2_DataList.Items[0].FindControl("cmbTipNorma") as ASPxComboBox;
                ASPxComboBox cmbDurTimpMunca = Test2_DataList.Items[0].FindControl("cmbDurTimpMunca") as ASPxComboBox;
                DataSet ds = Session["InformatiaCurentaPersonal"] as DataSet;
        ...
        private void cmbIntervalRepartizareTimpMunca_SelectedIndexChanged()
        {
            try
            {
                ASPxComboBox cmbIntervalRepartizareTimpMunca = Test2_DataList.Items[0].FindControl("cmbIntervRepTimpMunca") as ASPxComboBox;
                ASPxTextBox txtNrOreLunaSaptamana = Test2_DataList.Items[0].FindControl("txtNrOre") as ASPxTextBox;
        ...
        private void VerificaNrLuni()
        {
            try
            {
                ASPxComboBox cmbDurataContract = Test2_DataList.Items[0].FindControl("cmbDurCtr") as ASPxComboBox;
                ASPxDateEdit deDeLaData = Test2_DataList.Items[0].FindControl("deDeLaData") as ASPxDateEdit;
                ASPxDateEdit deDataAngajarii = Test2_DataList.Items[0].FindControl("deDataAng") as ASPxDateEdit;
                ASPxDateEdit deLaData = Test2_DataList.Items[0].FindControl("deLaData") as ASPxDateEdit;
                ASPxDateEdit deDataPlecarii = Test2_DataList.Items[0].FindControl("deDataPlecarii") as ASPxDateEdit;
                ASPxDateEdit deUltZiLucr = Test2_DataList.Items[0].FindControl("deUltimaZiLucr") as ASPxDateEdit;
                ASPxTextBox txtZile = Test2_DataList.Items[0].FindControl("txtNrZile") as ASPxTextBox;
                ASPxTextBox txtLuni = Test2_DataList.Items[0].FindControl("txtNrLuni") as ASPxTextBox;
                ASPxTextBox txtNrCtrIntern = Test2_DataList.Items[0].FindControl("txtNrCtrInt") as ASPxTextBox;
                ...
                else if (Convert.ToInt32(cmbDurataContract.Value) == 2)
                {
                    ...
                    if (deDeLaData.Value != null && deLaData.Value != null)
                    {
                        ...
                        if (deDeLaData.Value == null)
                            Test2_pnlCtl.JSProperties["cpAlertMessage"] =  Dami.TraduCuvant("Completati perioada pentru contractul pe perioada determinata!");

                        if (Convert.ToInt32(txtLuni.Text) > 36 || (Convert.ToInt32(txtLuni.Text) == 36 && Convert.ToInt32(txtZile.Text) > 0))
                            Test2_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Durata maxima a unui contract pe perioada determinata nu poate depasi 36 de luni");
                        else
                        {
                            ...
                            if (Convert.ToInt32(Session["Marca"].ToString()) != -99 && txtNrCtrIntern.Text != "")
                            {
                                ...
                                if (mesaj != null && mesaj != "") Test2_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant(mesaj).Substring(1);   
                            }
                        }
                    }
                }
        ...
        private void deDataPlecarii_EditValueChanged(object F100993)
        {
            ...
            {                
                ...
                if (Convert.ToDateTime(deDataAngajarii.Value) != null)
                    ...
                    {
                        Test2_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Data plecarii este anterioara datei angajarii!");
        ...
        private void deDeLaData_LostFocus(object F100933)
        {
            try
            {
                ...
                if (Convert.ToDateTime(deLaData.Value) != null)
                    ...
                    {
                        Test2_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Data start este ulterioara celei de final!");
        ...
        private void ActualizareZileLuni()
        {
            try
            {
                ...
                ASPxDateEdit deDataPlecarii = Test2_DataList.Items[0].FindControl("deDataPlecarii") as ASPxDateEdit;
                ASPxDateEdit deUltZiLucr = Test2_DataList.Items[0].FindControl("deUltimaZiLucr") as ASPxDateEdit;
                ASPxTextBox txtNrZile = Test2_DataList.Items[0].FindControl("txtNrZile") as ASPxTextBox;
                ASPxTextBox txtNrLuni = Test2_DataList.Items[0].FindControl("txtNrLuni") as ASPxTextBox;
                DataSet ds = Session["InformatiaCurentaPersonal"] as DataSet;
        ...
        {
            ASPxComboBox cmbGradInvalid = Test2_DataList.Items[0].FindControl("cmbGradInvalid") as ASPxComboBox;
            ASPxDateEdit dataValabilInvalid = Test2_DataList.Items[0].FindControl("deDataValabInvalid") as ASPxDateEdit;
            DataSet ds = Session["InformatiaCurentaPersonal"] as DataSet;
       ...
       private void txtVechimeInCompanieAni_LostFocus()
        ...
        private void txtDataPrimeiAngajari_LostFocus()
        {
            try
            {
                ASPxDateEdit deDataPrimeiAng = Test2_DataList.Items[0].FindControl("deDataPrimeiAng") as ASPxDateEdit;
                ASPxTextBox txtVechCarteMuncaAni = Test2_DataList.Items[0].FindControl("txtVechCarteMuncaAni") as ASPxTextBox;
                ASPxTextBox txtVechCarteMuncaLuni = Test2_DataList.Items[0].FindControl("txtVechCarteMuncaLuni") as ASPxTextBox;
        ...
        {
            ASPxDateEdit deDataAngajarii = Test2_DataList.Items[0].FindControl("deDataAng") as ASPxDateEdit;
            ASPxDateEdit deDataCrtIntern = Test2_DataList.Items[0].FindControl("deDataCtrInt") as ASPxDateEdit;
            DateTime dt = new DateTime(2100, 1, 1, 0, 0, 0);
            DataSet ds = Session["InformatiaCurentaPersonal"] as DataSet;
            if (deDataAngajarii.Value != null)
                if (Convert.ToDateTime(deDataCrtIntern.Value) >= Convert.ToDateTime(deDataAngajarii.Value))
                {
                    Test2_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Data contract intern trebuie sa fie anterioara datei angajarii!");
        ...
        private void cmbNorma_LostFocus()
        {
            try
            {
                ...
                {
                    Test2_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Nu ati completat norma!");
        ...
        private void cmbTimpPartial_SelectedIndexChanged()
        {
            try
            {
                ...
                {
                    Test2_pnlCtl.JSProperties["cpAlertMessage"] = Dami.TraduCuvant("Timpul partial este mai mare decat norma!");
                    cmbTimpPartial.SelectedItem.Value = 1;
                    ds.Tables[0].Rows[0]["F10043"] = 1;
                    ds.Tables[1].Rows[0]["F10043"] = 1;
                    Session["InformatiaCurentaPersonal"] = ds;
        ...
        private void cmbPrel_SelectedIndexChanged()
        {
            try
            {
                ...
                ASPxComboBox cmbPrelungireContract = Test2_DataList.Items[0].FindControl("cmbPrel") as ASPxComboBox;
                ASPxDateEdit deDeLaData = Test2_DataList.Items[0].FindControl("deDeLaData") as ASPxDateEdit;
                ASPxDateEdit deLaData = Test2_DataList.Items[0].FindControl("deLaData") as ASPxDateEdit;
                ASPxTextBox txtNrCtrIntern = Test2_DataList.Items[0].FindControl("txtNrCtrInt") as ASPxTextBox;
                DataSet ds = Session["InformatiaCurentaPersonal"] as DataSet;
        ...
        //{
        //    Test2_pnlCtl.Controls.Add(new LiteralControl());
        //    WebControl script = new WebControl(HtmlTextWriterTag.Script);
        //    Test2_pnlCtl.Controls.Add(script);
