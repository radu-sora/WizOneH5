...
{
    public partial class CandidatiLista : System.Web.UI.Page
    {
        ...
        private void IncarcaGrid(bool AdaugaColoanele = true)
        {
            ...
            try
            {
                ...
                if (AdaugaColoanele)
                {
                    ...
                    //traducem tooltip-urile
                    //for (int i = 0; i < dt.Rows.Count; i++)
                    //{
                    //    ASPxButton btnEdit = grDate.FindRowCellTemplateControl(i, (GridViewDataColumn)grDate.Columns["cmd_col_custom"], "btnEdit") as ASPxButton;
                    //    btnEdit.ToolTip = Dami.TraduCuvant("Modifica");
                    //    ASPxButton btnDelete = grDate.FindRowCellTemplateControl(i, (GridViewDataColumn)grDate.Columns["cmd_col_custom"], "btnDelete") as ASPxButton;
                    //    btnDelete.ToolTip = Dami.TraduCuvant("Sterge");
                    //    ASPxButton btnClone = grDate.FindRowCellTemplateControl(i, (GridViewDataColumn)grDate.Columns["cmd_col_custom"], "btnClone") as ASPxButton;
                    //    btnClone.ToolTip = Dami.TraduCuvant("Duplicare");
                    //}
                }
            }
            catch (Exception ex)
        ...
        //protected void grDate_RowCommand(object sender, ASPxGridViewRowCommandEventArgs e)
        //{
        //    try
        //    {
        //        ASPxButton btn = e.CommandSource as ASPxButton;
        //        if (btn != null)
        //        {
        //            switch(btn.ID)
        //            {
        ...
        //                                                       if (url != "")
        //                        {
        //                            Session["Sablon_CheiePrimara"] = e.KeyValue;
        //                            Session["Sablon_TipActiune"] = btn.ID.ToString().Replace("btn", "");
        //                            Response.Redirect(url, false);
        //                        }
        //                    }
        //                    break;
        ...
        //                                          END;", new string[] { e.KeyValue.ToString() });
        //                                break;
        //                            case "Intro":
        //                                General.ExecutaNonQuery(@"BEGIN
