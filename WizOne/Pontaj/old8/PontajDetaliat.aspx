        ...
        <tr>
            <td colspan="2">
                ...
                <dx:ASPxGridView ID="grDate" runat="server" ClientInstanceName="grDate" ClientIDMode="Static" Width="100%" AutoGenerateColumns="false" 
                    ...
                    OnFocusedRowChanged="grDate_FocusedRowChanged" >
                    <SettingsBehavior AllowSelectByRowClick="true" AllowFocusedRow="true" AllowSelectSingleRowOnly="false" EnableCustomizationWindow="true" ColumnResizeMode="Control" ProcessFocusedRowChangedOnServer="false" />
                    ...
                    <ClientSideEvents ContextMenu="ctx" BatchEditEndEditing="OnBatchEditEndEditing" BatchEditStartEditing="OnBatchEditStartEditing"
                        RowClick="function(s, e) { hfRowIndex.Set('rowIndex',e.visibleIndex); }"
