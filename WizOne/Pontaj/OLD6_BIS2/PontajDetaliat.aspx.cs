    ...
    public partial class PontajDetaliat : System.Web.UI.Page
    {
                ...
                if (Dami.ValoareParam("PontajulAreCC") == "1")
                {
                    ...
                    if (!IsPostBack)
                    {
                        ...
                        for (int i = 0; i < dtAd.Rows.Count; i++)
                        {
                            ...
                            #region Old
                            //string colNume = dtAd.Rows[i]["Camp"].ToString();
                            ...
                            //            c.Name = colNume;
                            //            c.FieldName = colNume;
                            //            c.Caption = Dami.TraduCuvant(dtAd.Rows[i]["Alias"].ToString());
                            //            c.VisibleIndex = i + 4;
                            //            c.PropertiesComboBox.AllowNull = true;
                            //            c.PropertiesComboBox.ValueField = "F06204";
                            //            c.PropertiesComboBox.TextField = "F06205";
                            //            c.PropertiesComboBox.ValueType = Type.GetType("System.Int32");
                            ...
                            //            c.VisibleIndex = i + 4;
                            //            c.PropertiesComboBox.AllowNull = true;
                            //            c.PropertiesComboBox.ValueField = "IdDept";
                            //            c.PropertiesComboBox.TextField = "Dept";
                            //            c.PropertiesComboBox.ValueType = Type.GetType("System.Int32");

                            //            ListBoxColumn colFil = new ListBoxColumn();
                            //            colFil.FieldName = "Filiala";
                            //            colFil.Caption = "Filiala";
                            //            colFil.Width = 130;
                            //            c.PropertiesComboBox.Columns.Add(colFil);

                            //            ListBoxColumn colSec = new ListBoxColumn();
                            //            colSec.FieldName = "Sectie";
                            //            colSec.Caption = "Sectie";
                            //            colSec.Width = 130;
                            //            c.PropertiesComboBox.Columns.Add(colSec);

                            //            ListBoxColumn colDept = new ListBoxColumn();
                            //            colDept.FieldName = "Dept";
                            //            colDept.Caption = "Dept";
                            //            colDept.Width = 130;
                            //            c.PropertiesComboBox.Columns.Add(colDept);
                    ...
                    //s-a mutata in grDate_CellEditorInitialize
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (tip == 1 || tip == 10)
                    txtTitlu.Text = "Pontaj - Pontaj - Pontaj pe angajat";
                else
                    txtTitlu.Text = "Pontaj - Pontaj - Pontaj pe zi";
                ...
                if (!IsPostBack)
                {
                    ...
                    if (tip == 1 || tip == 10) IncarcaAngajati();
                ...
                //    var ert = grCC.FindEditRowCellTemplateControl(colPro, "cmbPro");
                //    ASPxComboBox cmbPro = grCC.FindEditRowCellTemplateControl(colPro, "cmbPro") as ASPxComboBox;
                //    var edc = grCC.FindControl("cmbPro");
                //    if (cmbPro != null)
                //    {
                //        cmbPro.DataSource = Session["PtjCC_Proiecte"];
                //        cmbPro.DataBind();
                //    }
                //}

                //GridViewDataComboBoxColumn colSubPro = (grCC.Columns["IdSubproiect"] as GridViewDataComboBoxColumn);
                //if (colSubPro != null) colSubPro.PropertiesComboBox.DataSource = Session["PtjCC_SubProiecte"];

                //GridViewDataComboBoxColumn colAct = (grCC.Columns["IdActivitate"] as GridViewDataComboBoxColumn);
                //if (colAct != null) colAct.PropertiesComboBox.DataSource = Session["PtjCC_Activitati"];
        ...
        protected void btnPtjEchipa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dt.GetChanges() != null && ((DataTable)dt.GetChanges()).Rows.Count > 0)
                    MessageBox.Show("Va rugam salvati sau respingeti modificarile", MessageBox.icoWarning, "Exista modificari !");
                else
                    Response.Redirect("~/Pontaj/PontajEchipa.aspx?tip=1", true);
            }
            catch (Exception)
            {
        ...
        public DataTable PontajCuInOut()
        {
            ...
            try
            {
                ...
                string strSql = $@"SELECT P.*, {General.FunctiiData("P.\"Ziua\"", "Z")} AS ""Zi"", P.""Ziua"", A.F10008 {op} ' ' {op} A.F10009 AS ""NumeComplet"" {valTmp} ,
                            ...
                            L.""Denumire"" AS ""DescContract"", COALESCE(L.""OreSup"",1) AS ""OreSup"", COALESCE(L.""Afisare"",1) AS ""Afisare"",
                            ...
                            CASE WHEN M.""Id"" IS NULL THEN 0 ELSE 1 END AS ""VineDinCereri"", A.F10022, A.F10023,
                            ...
                            (((CASE WHEN(P.""ZiSapt"" < 6 AND P.""ZiLibera"" = 0) THEN 1 ELSE 0 END) = B.ZL) OR
                            ((CASE WHEN(P.""ZiSapt"" = 6 AND P.""ZiSapt"" = 7) THEN 1 ELSE 0 END) = B.SD) OR
                            P.""ZiLibera"" = B.SL) 
                            GROUP BY A.""OreInVal""
                            ORDER BY A.""OreInVal""
...
#region grDate
            ...
            try
            {
                ...
                if (dt.GetChanges() != null && ((DataTable)dt.GetChanges()).Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dtModif.Rows.Count; i++)
                    {
                        ...
                        FunctiiCeasuri.Calcul.CalculInOut(dtModif.Rows[i], true, true, false);
                    }
                        ...
                        case "btnRecalcParam":
                            {
                                ...
                                for (int i = 0; i < dt.Rows.Count; i++)
                                {
                                    ...
                                    FunctiiCeasuri.Calcul.CalculInOut(dt.Rows[i], true, true, true);
                                }
                                Session["InformatiaCurenta"] = dt;
                                grDate.DataBind();
                            }
        ...
        protected void grDate_DataBound(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var rowValues = grid.GetRowValues(i, new string[] { "Cheia", "ValActive" }) as object[];
        ...
        private void CreazaGrid()
        {
            try
            {
                DataTable dtCol = General.IncarcaDT(@"SELECT A.*, 
                                ...
                                CASE WHEN SUBSTRING(A.Coloana,1,3)='Val' AND COALESCE(B.DenumireScurta,'') <> '' THEN REPLACE(B.DenumireScurta,' ','') ELSE A.Alias END AS ColAlias
                                FROM Ptj_tblAdmin A
                            ...
                            case 2:                             //ComboBox
                                {
                                    ...
                                    if (colName == "ValAbs") c.UnboundType = DevExpress.Data.UnboundColumnType.String;
        ...
        private void ExecCalcul(string ids)
        {
            try
            {
                ...
                {
                    CalculFormuleCumulat(Convert.ToInt32(arr[i]), ziua.Year, ziua.Month);
                }
            }
            catch (Exception ex)
            {
        ...
        private void CalculFormuleCumulat(int f10003, int an, int luna)
        {
            try
            {
                string strSql = "";
        ...
        //protected void pnlCC_Callback(object sender, CallbackEventArgsBase e)
        //{
        //    try
        //    {
        ...
        //        dtCC.PrimaryKey = new DataColumn[] { dtCC.Columns["IdAuto"] };
        ...
        protected void grCC_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            try
            {
                //if (e.NewValues["F06204"] == null || e.NewValues["De"] == null || e.NewValues["La"] == null || Convert.ToDateTime(e.NewValues["De"]).Year <= 2000 || Convert.ToDateTime(e.NewValues["La"]).Year <= 2000)
                if (e.NewValues["F06204"] == null)
                {
                    //msgError = ex.Message;
                    return;
                }
        ...
        protected void grCC_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            try
            {
                ...
                foreach (DictionaryEntry col in e.NewValues)
                {
                    ...
                    {
                        //if (col.Key.ToString() == "NrOreUnbound")
                        //{
                        //    if (col.Value != null)
                        //        row["NrOre"] = Convert.ToDateTime(col.Value).Hour * 60 + Convert.ToDateTime(col.Value).Minute;
                        //    else
                        //        row["NrOre"] = DBNull.Value;
                        //}
                        //else
        ...
        protected void grCC_InitNewRow(object sender, DevExpress.Web.Data.ASPxDataInitNewRowEventArgs e)
        {
            try
            {
                ...
                //e.NewValues["De"] = new DateTime(Convert.ToDateTime(lst[1]).Year, Convert.ToDateTime(lst[1]).Month, Convert.ToDateTime(lst[1]).Day,8,0,0);
                //e.NewValues["La"] = new DateTime(Convert.ToDateTime(lst[1]).Year, Convert.ToDateTime(lst[1]).Month, Convert.ToDateTime(lst[1]).Day, 9, 0, 0);
        ...
        protected void btnSaveCC_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmp != "")
                {
                    ...
                    List<object> lst = ValoriChei();
                    string strSql = $@"UPDATE Ptj_Intrari SET {cmp.Substring(1)} WHERE F10003=@1 AND Ziua=@2 ";
                    strSql = strSql.Replace("@1", lst[0].ToString()).Replace("@2", General.ToDataUniv(Convert.ToDateTime(lst[1])));
                    General.ExecutaNonQuery(strSql, null);

                    //recalcul f-uri la nivel de luna
                    DateTime zi = Convert.ToDateTime(lst[1]);
                    CalculFormuleCumulat(Convert.ToInt32(lst[0]), zi.Year, zi.Month);
                }
            }
            catch (Exception ex)
            {
        ...
        protected void grCC_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
            try
            {
                ...
                //if (!grCC.IsEditing || e.Column.FieldName != "City") return;
                //if (e.KeyValue == DBNull.Value || e.KeyValue == null) return;
                //object val = grCC.GetRowValuesByKeyValue(e.KeyValue, "Country");
                    ...
                    case "IdSubproiect":
                        {
                            ...
                            {
                                object val = grCC.GetRowValuesByKeyValue(e.KeyValue, "IdProiect");
                                if (val == DBNull.Value) return;
                                Int32 idPro = (Int32)val;
        ...
        protected void grCC_HtmlEditFormCreated(object sender, ASPxGridViewEditFormEventArgs e)
        {
            try
            {
                object[] obj = grCC.GetRowValues(grCC.FocusedRowIndex, new string[] { "IdStare", "F06204", "IdProiect", "IdSubproiect", "IdActivitate", "IdDept" }) as object[];

                ASPxComboBox cmbStr = grCC.FindEditFormTemplateControl("cmbStr") as ASPxComboBox;
                if (cmbStr != null)
                {
                    DataTable dt = General.IncarcaDT(@"SELECT ""Id"", ""Denumire"", ""Culoare"" FROM ""Ptj_tblStari"" ", null);
                    cmbStr.DataSource = dt;
                    cmbStr.DataBind();
                    cmbStr.Value = obj[0];
                }

                ASPxComboBox cmbF062 = grCC.FindEditFormTemplateControl("cmbF062") as ASPxComboBox;
                if (cmbF062 != null)
                {
                    DataTable dt = General.IncarcaDT(@"SELECT * FROM ""F062"" ", null);
                    cmbF062.DataSource = dt;
                    cmbF062.DataBind();
                    cmbF062.Value = obj[1];
                }

                ASPxComboBox cmbPro = grCC.FindEditFormTemplateControl("cmbPro") as ASPxComboBox;
                if (cmbPro != null)
                {
                    DataTable dt = General.IncarcaDT(@"SELECT * FROM ""tblProiecte"" ", null);
                ...
                //ASPxComboBox cmbSub = grCC.FindEditFormTemplateControl("cmbSub") as ASPxComboBox;
                //if (cmbSub != null)
                //{
                //    DataTable dt = General.IncarcaDT(@"SELECT * FROM ""tblSubProiecte"" ", null);
        ...
        protected void cmbPro_Callback(object sender, CallbackEventArgsBase e)
        {
            ASPxComboBox cmbSub = grCC.FindEditFormTemplateControl("cmbSub") as ASPxComboBox;
            if (cmbSub != null)
            {
