    ...
    public partial class ActeAditionale : System.Web.UI.Page
    {
                        ...
                        case "btnUnire":
                            {
                                for (int i = 0; i < lst.Count(); i++)
                                {
                                    try
                                    {
                                        object[] obj = lst[i] as object[];
                                        int f10003 = -99;
                                        DateTime ziua = new DateTime(1975, 03, 25);
                                        if (i==0)
                                        {
                                            f10003 = Convert.ToInt32(obj[0]);
                                            ziua = Convert.ToDateTime(obj[1]);
                                        }

                                        if (Convert.ToInt32(General.Nz(obj[7], 0)) != 0)
                                        {
                                            msg += Dami.TraduCuvant("Exista linii trimise in Revisal") + System.Environment.NewLine;
                                            break;
                                        }

                                        if (Convert.ToInt32(General.Nz(obj[0], 0)) != f10003)
                                        {
                                            msg += Dami.TraduCuvant("Angajatul trebuie sa fie acelasi") + System.Environment.NewLine;
                                            break;
                                        }
                                        if (Convert.ToDateTime(General.Nz(obj[1], 0)) != ziua)
                                        {
                                            msg += Dami.TraduCuvant("Data modificare trebuie sa fie aceeasi") + System.Environment.NewLine;
                                            break;
                                        }
        ...
        protected void grDate_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            try
            {
                ...
                object[] obj = grDate.GetRowValues(grDate.FocusedRowIndex, new string[] { "IdAutoAct", "F10003", "DataModif", "Revisal" }) as object[];
