...
namespace WizOne.Eval
{
    public partial class EvalDetaliu : System.Web.UI.Page
    {
        ...
        private int _idQuiz
        {
            get { return (Session["CompletareChestionar_IdQuiz"] as int? ?? 1); }
        }

        private int _f10003
        {
            get { return (Session["CompletareChestionar_F10003"] as int? ?? 1); }
        }
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    DataTable tableAAA = General.IncarcaDT(@"SELECT * FROM ""Eval_Raspuns"" WHERE ""IdQuiz"" = @1 AND ""F10003"" = @2", new object[] { General.Nz(Session["CompletareChestionar_IdQuiz"], -99), General.Nz(Session["CompletareChestionar_F10003"], -99) });
                    tableAAA.TableName = "Eval_Raspuns";

                    DataTable tableBBB = General.IncarcaDT(@"SELECT * FROM ""Eval_RaspunsLinii"" WHERE ""IdQuiz"" = @1 AND ""F10003"" = @2", new object[] { General.Nz(Session["CompletareChestionar_IdQuiz"], -99), General.Nz(Session["CompletareChestionar_F10003"], -99) });
                    tableBBB.TableName = "Eval_RaspunsLinii";

                    DataTable tableCCC = General.IncarcaDT(@"SELECT * FROM ""Eval_QuizIntrebari"" WHERE ""IdQuiz"" = @1", new object[] { General.Nz(Session["CompletareChestionar_IdQuiz"], -99) });
                    ...
                    //Florin 2018.12.20
                    Session["Aprobat360"] = Convert.ToInt32(General.Nz(General.ExecutaScalar($@"SELECT COALESCE(""Aprobat"",0) FROM ""Eval_RaspunsIstoric"" WHERE ""IdQuiz""=@1 AND F10003=@2 AND ""IdUser""=@3", new object[] { Session["CompletareChestionar_IdQuiz"], Session["CompletareChestionar_F10003"], Session["UserId"] }), 1));
                    ...
                    //Radu 17.07.2018
                    int IdQuiz = Convert.ToInt32(Session["CompletareChestionar_IdQuiz"] ?? -99);
                    int F10003 = Convert.ToInt32(Session["CompletareChestionar_F10003"] ?? -99);


                    #region Luat la cunostinta

                    //Florin 2019.01.29
                    if (tableAAA != null && tableAAA.Rows.Count > 0)
                    {
                        if (F10003 == Convert.ToInt32(General.Nz(Session["User_Marca"], -98)) && _finalizat == 1 && _trebuieSaIaLaCunostinta == 1 && _aLuatLaCunostinta == 0) btnLuatCunostinta.Visible = true;
                    }
                    ...
                    //Florin 2018.12.18
                    List<metaEvalDenumireSuper> lstEvalDenumireSuper = Evaluare.EvalDenumireSuper(IdQuiz, Convert.ToInt32(General.Nz(Session["Eval_PozitieUserLogat"],1)), consRU);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int idQuiz = Convert.ToInt32(Session["CompletareChestionar_IdQuiz"]);
                int f10003 = Convert.ToInt32(Session["CompletareChestionar_F10003"]);
                ...
                if (Dami.ValoareParam("PreluareDateAutomat", "0") == "1" && idCateg == "0")
                    PreluareDateAutomat(idQuiz, f10003, pozitie);
                    ...
                    if (raspLinie != null)
                    {
                        if (Convert.ToInt32(_idClient) == 20)
                        {
                            if (raspLinie.TipData == 3 && raspLinie.TipValoare == 8)
                            {
                                ...
                                int idQuiz = Convert.ToInt32(General.Nz(Session["CompletareChestionar_IdQuiz"],-99));
                                int f10003 = Convert.ToInt32(General.Nz(Session["CompletareChestionar_F10003"], -99));
                                ...
                                DataTable dt = General.IncarcaDT(
                                    ...
                                    and ""IdLinieQuiz"" in (select ""Id"" from ""Eval_QuizIntrebari"" where ""IdQuiz"" = @1 and ""TipData"" = 23)", new object[] { idQuiz, f10003, pozitie });
                                ...
                                if (pozitie == 2)
                                {
                                    ...
                                    //DataTable dtObi = General.IncarcaDT(@"SELECT * FROM ""Eval_ObiIndividualeTemp"" WHERE ""IdQuiz""=@1 AND F10003=@2 AND ""Pozitie""=@3", new object[] { Session["CompletareChestionar_IdQuiz"], Session["CompletareChestionar_F10003"], pozitie });
        ...
        private void CreeazaSectiune(string super)
        {
            try
            {
                ...
                int pozitie = Convert.ToInt32(Session["CompletareChestionar_Pozitie"] ?? -99);
                int idQuiz = Convert.ToInt32(Session["CompletareChestionar_IdQuiz"] ?? -99);
                int blocat = Convert.ToInt32(General.Nz(General.ExecutaScalar(@"SELECT MAX(COALESCE(""Blocat"",0)) FROM ""Eval_DrepturiTab"" WHERE ""IdQuiz"" = @1 AND ""Pozitie"" = @2 AND ""TabIndex"" = @3 ", new object[] { idQuiz, super.Replace("Super",""), indexSec+1 }), 0));
        ...
        private ASPxGridView CreeazaObiectiveIndividuale(int id, int idGrupValori, string super)
        {
            ...
            if (Session["lstEval_ObiIndividualeTemp"] == null)
            {
                ...
                DataTable dtObiIndividuale = General.IncarcaDT(@"select * from ""Eval_ObiIndividualeTemp"" WHERE F10003=@1 ORDER BY ""Obiectiv"", ""Activitate"" ", new object[] { F10003 });
            ...
            try
            {
                ...
                //Florin 2018.07.09
                //string idCateg = General.Nz(General.ExecutaScalar(@"SELECT ""CategorieQuiz"" FROM ""Eval_Quiz"" WHERE ""Id""=" + Session["CompletareChestionar_IdQuiz"], null), "0").ToString();
                int y = 34;
                        ...
                        if (clsConfigDetail.ColumnName == "Obiectiv")
                        {
                            if (clsConfigDetail.TipValoare == 1)
                            {
                                ...
                                if (Session["feedEval_Obiectiv"] == null)
                                {
                                    ...
                                    //strSQLObiectiv = string.Format(strSQLObiectiv, clsConfigDetail.IdNomenclator, Session["CompletareChestionar_F10003"]);
                                    DataTable dtObiectiv = General.IncarcaDT(strSQLObiectiv, new object[] { clsConfigDetail.IdNomenclator, Session["CompletareChestionar_F10003"] });
                                ...
                                if (Session["feedEval_ObiectivActivitate"] == null)
                                {
                                    ...
                                    //strSQLObiectivActivitate = string.Format(strSQLObiectivActivitate, clsConfigDetail.IdNomenclator, Session["CompletareChestionar_F10003"]);
                                    DataTable dtObiectivActivitate = General.IncarcaDT(strSQLObiectivActivitate, new object[] { clsConfigDetail.IdNomenclator, Session["CompletareChestionar_F10003"] });
                                    lstActivitati.Clear();
                ...
                var erf = lstEval_ObiIndividualeTemp.Where(p => p.IdLinieQuiz == id && p.F10003 == F10003 && p.Pozitie == Convert.ToInt32(Session["Eval_ActiveTab"]) && p.IdQuiz == IdQuiz).ToList();
                //Florin 2019.01.29
                grDateObiective.DataSource = lstEval_ObiIndividualeTemp.Where(p => p.IdLinieQuiz == id && p.F10003 == F10003 && p.Pozitie == Convert.ToInt32(Session["Eval_ActiveTab"]) && p.IdQuiz == IdQuiz).ToList();
                ////Florin 2019.01.08
                ...
                {//daca formularul este pe pozitia 1, evaluatorul sa poata completa comentariile pe tab-ul sau
                    if (idCateg == "0")
                    {
                        ...
                        if (poz == 1 && Session["Eval_ActiveTab"].ToString() == "1")
                        {
                            ...
                            DataTable dt = General.IncarcaDT(@"SELECT ""IdUser"" FROM ""Eval_RaspunsIstoric"" WHERE ""IdQuiz"" = @1 and F10003 = @2 AND ""Pozitie"" = 2", new object[] { IdQuiz, F10003 });
                            if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0] != null && dt.Rows[0][0].ToString().Length > 0)
                            {
        ...
        private void GrDateObiective_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            try
            {
                ...
                clsObiIndividual.F10003 = Convert.ToInt32(Session["CompletareChestionar_F10003"].ToString());
                clsObiIndividual.Pozitie = poz;
                clsObiIndividual.IdQuiz = Convert.ToInt32(Session["CompletareChestionar_IdQuiz"].ToString());
        ...
        private void GrDateObiective_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            try
            {
                ...
                clsNew.F10003 = Convert.ToInt32(Session["CompletareChestionar_F10003"].ToString());
                ...
                clsNew.Pozitie = poz;
                clsNew.IdQuiz = Convert.ToInt32(Session["CompletareChestionar_IdQuiz"].ToString());
        ...
        private void GrDateObiective_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            try
            {
                ...
                int F10003 = Convert.ToInt32(Session["CompletareChestionar_F10003"].ToString());
                int Pozitie = Convert.ToInt32(Session["CompletareChestionar_Pozitie"].ToString());
                int IdQuiz = Convert.ToInt32(Session["CompletareChestionar_IdQuiz"].ToString());


                //Florin 2018.01.29
                Pozitie = Convert.ToInt32(Session["Eval_ActiveTab"]);
                ...
                Session["lstEval_ObiIndividualeTemp"] = lst;
                e.Cancel = true;
                grid.DataSource = lst.Where(p => p.IdQuiz == IdQuiz && p.F10003 == F10003 && p.IdLinieQuiz == IdLinieQuiz && p.Pozitie == Pozitie).ToList();
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex, MessageBox.icoError, "Atentie !");
        ...
        private ASPxGridView CreeazaCompetenteAngajat(int id, int idGrupValori, string super)
        {
            ...
            if (Session["lstEval_CompetenteAngajatTemp"] == null)
            {
                ...
                DataTable dtCompetenteAngajat = General.IncarcaDT(@"select * from ""Eval_CompetenteAngajatTemp"" WHERE ""IdQuiz""=@1 AND F10003=@2 ORDER BY ""Competenta"" ", new object[] { IdQuiz, F10003 });
            ...
            try
            {
                    ...
                    if (clsConfigDetail.Vizibil == true)
                    {
                        ...
                        if (clsConfigDetail.ColumnName == "Competenta")
                        {
                            ...
                            if (Session["feedEval_Competenta"] == null)
                            {
                                ...
                                //strSQLCompetenta = string.Format(strSQLCompetenta, clsConfigDetail.IdNomenclator, Session["CompletareChestionar_F10003"]);
                                DataTable dtCompetenta = General.IncarcaDT(strSQLCompetenta, new object[] { clsConfigDetail.IdNomenclator, Session["CompletareChestionar_F10003"] });
                ...
                //Florin 2019.01.29
                grDateCompetente.DataSource = lstEval_CompetenteAngajatTemp.Where(p => p.F10003 == F10003 && p.IdLinieQuiz == id && p.Pozitie == Convert.ToInt32(Session["Eval_ActiveTab"])).ToList();
                ////Florin 2018.12.10
                //if (Convert.ToInt32(_idClient) == 20 && idCateg != "0")
        ...
        private void GrDateCompetente_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            try
            {
                ...
                clsCompetenteAngajat.IdQuiz = Convert.ToInt32(Session["CompletareChestionar_IdQuiz"].ToString());
                clsCompetenteAngajat.F10003 = Convert.ToInt32(Session["CompletareChestionar_F10003"].ToString());
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["CompletareChestionar_IdQuiz"] != null)
                    idQuiz = Session["CompletareChestionar_IdQuiz"].ToString();
                if (Session["CompletareChestionar_F10003"] != null)
                    F10003 = Session["CompletareChestionar_F10003"].ToString();
                ...
                Session["PrintParametrii"] = idQuiz+ ";" + F10003 + ";" + Session["UserId"] + ";Super" + poz + ";0";
        ...
        private void btnFinalizare_ItemClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string msg = QuizAproba(idQuiz, F10003, Convert.ToInt32(Session["UserId"].ToString()));
				...
				msg = Notif.TrimiteNotificare("Eval.EvalLista", (int)Constante.TipNotificare.Notificare, @"SELECT *, 1 AS ""Actiune"" FROM ""Eval_Raspuns"" WHERE ""IdQuiz""=" + idQuiz + @"AND F10003 = " + F10003, "", -99, Convert.ToInt32(Session["UserId"] ?? -99), Convert.ToInt32(Session["User_Marca"] ?? -99));
				if (msg.Length > 0)                    
        ...
        public string QuizAproba(int idQuiz, int f10003, int idUser)
        {
            ...
            try
            {
                ...
                int este = Convert.ToInt32(General.Nz(General.ExecutaScalar(strSql, new object[] { idQuiz, f10003, idUser } ),0));
                if (este == 1)
                    return "Formularul este deja aprobat";

                //string sql = "";                
                //sql = "SELECT * FROM ""Eval_Quiz"" WHERE ""Id"" = " +idQuiz;
                DataTable entQz = General.IncarcaDT(@"SELECT * FROM ""Eval_Quiz"" WHERE ""Id"" = @1", new object[] { idQuiz });

                //sql = "SELECT * FROM ""Eval_Raspuns"" WHERE ""IdQuiz"" = " + idQuiz + " AND F10003 = " + f10003;
                DataTable ent = General.IncarcaDT(@"SELECT * FROM ""Eval_Raspuns"" WHERE ""IdQuiz"" = @1 AND F10003 = @2", new object[] { idQuiz, f10003 });
                //sql = "SELECT * FROM ""Eval_RaspunsIstoric"" WHERE ""IdQuiz"" = " + idQuiz + " AND F10003 = " + f10003;
                DataTable lstIst = General.IncarcaDT(@"SELECT * FROM ""Eval_RaspunsIstoric"" WHERE ""IdQuiz"" = @1 AND F10003 = @2", new object[] { idQuiz, f10003 });
                ...
                DataTable entIst = General.IncarcaDT(
                    ...
                    @2 AND b.""IdSuper"" = (-1) * a.""IdSuper""))) ORDER BY ""Pozitie"" ", new object[] { idQuiz, f10003, idUser });       
                ...
                DataTable entCir = General.IncarcaDT(@"SELECT * FROM ""Eval_Circuit"" WHERE ""IdQuiz"" = @1", new object[] { idQuiz });
                ...
                DataTable entPoz = General.IncarcaDT(@"SELECT * FROM ""Eval_RaspunsIstoric"" WHERE ""IdQuiz"" = @1 AND F10003 = @2 AND ""Aprobat"" IS NULL AND ""Pozitie"" = @3 ORDER BY ""Pozitie"" ", new object[] { idQuiz, f10003, (entIst.Rows[0]["Pozitie"] != DBNull.Value ? entIst.Rows[0]["Pozitie"].ToString() : "-99") });
                ...
                DataTable entDtFin = General.IncarcaDT(@"SELECT * FROM ""Eval_RaspunsLinii"" WHERE ""IdQuiz"" = @1 AND F10003 = @2 AND ""TipData"" = 36", new object[] { idQuiz, f10003 });
                if (entDtFin != null && entDtFin.Rows.Count > 0)
                {
                    ...
                    General.IncarcaDT(sql, new object[] { idQuiz, f10003 });
                }
                ...
                General.IncarcaDT(@"UPDATE ""Eval_Raspuns"" SET ""Pozitie"" = @1, ""Culoare"" = @2, ""Finalizat"" = @3 WHERE ""IdQuiz"" = @4 AND F10003 = @5", new object[] { ent.Rows[0]["Pozitie"].ToString(), ent.Rows[0]["Culoare"].ToString(), (ent.Rows[0]["Finalizat"] != DBNull.Value ? ent.Rows[0]["Finalizat"].ToString() : "0").ToString(), idQuiz, f10003 });
                ...
                General.IncarcaDT(
                    ...
                    (""IdSuper"" < 0 AND @7 IN (SELECT ""IdUser"" FROM ""F100Supervizori"" b where F10003 = @6 AND b.""IdSuper"" = (-1) * ""Eval_RaspunsIstoric"".""IdSuper"" ))) AND (""Aprobat"" IS NULL OR ""Aprobat"" = 0)", new object[] { (Constante.tipBD == 1 ? "GETDATE()" : "SYSDATE"), culoare, idUser, (Constante.tipBD == 1 ? "GETDATE()" : "SYSDATE"), idQuiz, f10003, idUser });
                ...
                if (Convert.ToInt32(_idClient) == 21 && Convert.ToInt32(ent.Rows[0]["Pozitie"].ToString()) - 1 == 2 && !fin)
                {
                    ...
                    General.IncarcaDT(@"UPDATE ""Eval_RaspunsIstoric"" SET ""IdUser"" = @1 WHERE ""IdQuiz"" = @2 AND F10003 = @3 AND ""Pozitie"" = 2 ", new object[] { idUser, idQuiz, f10003 });
                }
                ...
                if (ent.Rows[0]["Finalizat"].ToString() != "1")
                {
                    ...
                    DataTable dtCompetente = General.IncarcaDT(@"SELECT ""Id"" FROM ""Eval_QuizIntrebari"" WHERE ""IdQuiz"" = @1 AND ""TipData"" = 5", new object[] { idQuiz });
                    ...
                    if (dtCompetente != null && dtCompetente.Rows.Count > 0)
                    {
                        for (int i = 0; i < dtCompetente.Rows.Count; i++)
                        {
                            ...
                            General.IncarcaDT(@"DELETE FROM ""Eval_CompetenteAngajatTemp"" WHERE ""IdLinieQuiz"" = @1 AND F10003 = @2 AND ""Pozitie"" = @3 AND ""IdQuiz"" = @4 ", new object[] { dtCompetente.Rows[i][0].ToString(), f10003, Convert.ToInt32(ent.Rows[0]["Pozitie"].ToString()), idQuiz });
                            ...
                            General.IncarcaDT(sql, new object[] { Convert.ToInt32(ent.Rows[0]["Pozitie"].ToString()), dtCompetente.Rows[i][0].ToString(), f10003, Convert.ToInt32(ent.Rows[0]["Pozitie"].ToString()) - 1, idQuiz });
                        }
                    }
                }
                ...
                if (entQz != null && entQz.Rows.Count > 0 && Convert.ToInt32(entQz.Rows[0]["Preluare"] != DBNull.Value ? entQz.Rows[0]["Preluare"].ToString() : "0") == 1 && Convert.ToInt32(entIst.Rows[0]["Pozitie"] != DBNull.Value ? entIst.Rows[0]["Pozitie"].ToString() : "-99") < Convert.ToInt32(ent.Rows[0]["TotalCircuit"].ToString()))
                    QuizPreluareDate(idQuiz, f10003, Convert.ToInt32(entIst.Rows[0]["Pozitie"] != DBNull.Value ? entIst.Rows[0]["Pozitie"].ToString() : "-99"));
        ...
        private void QuizPreluareDate(int idQuiz, int f10003, int poz)
        {
            try
            {
                ...
                General.IncarcaDT(
                    ...
                    WHERE ""IdQuiz""=@1 AND F10003=@2 AND ""Super{poz+1}"" is null AND ""Super{poz}"" is not null", new object[] { idQuiz, f10003 });
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex, MessageBox.icoError, "Atentie !");
            ...
            try
            {
                if (Session["feedEval_ObiectivActivitate"] == null)
                {
                    string strSQLObiectivActivitate = @"select ob.""IdObiectiv"" as ""Parinte"", obAct.""IdActivitate"" as ""Id"", obAct.""Activitate"" as ""Denumire""
                                                                            ...
                                                                            where setAng.""Id"" = @1
                                                                            group by ob.""IdObiectiv"", obAct.""IdActivitate"", obAct.""Activitate"" ";
                    strSQLObiectivActivitate = string.Format(strSQLObiectivActivitate, Session["CompletareChestionar_F10003"]);
                    DataTable dtObiectivActivitate = General.IncarcaDT(strSQLObiectivActivitate, new object[] { Session["CompletareChestionar_F10003"] });
                    lstActivitati.Clear();
                    foreach (DataRow rwObiectivActivitate in dtObiectivActivitate.Rows)
                    {
                        metaDate clsObiectivActivitate = new metaDate();
        ...
        private ASPxGridView CreazaTabel(int id, int parinte, string numeView)
        {
            ...
            try
            {
                ...
                //sql = string.Format(sql, Session["CompletareChestionar_IdQuiz"].ToString(), parinte);
                DataTable dtIntreb = General.IncarcaDT(@"SELECT ""Id"", ""Descriere"" FROM ""Eval_QuizIntrebari"" WHERE ""IdQuiz"" = @1 AND ""Parinte"" = @2 AND (""Descriere"" like '%Vitality%' OR ""Descriere"" like '%Effectiveness%' OR ""Descriere"" like '%Common Sense%' OR ""Descriere"" like '%Creativity%' OR ""Descriere"" like '%Relationships%' OR ""Descriere"" like '%Others%')", new object[] { Session["CompletareChestionar_IdQuiz"].ToString(), parinte });
                string descriere = "";
                ...
                //sql = string.Format(sql, numeView, Session["CompletareChestionar_F10003"].ToString(), descriere, op);
                DataTable dt = General.IncarcaDT($@"SELECT * FROM ""{numeView}"" WHERE F10003 = @1 AND '{descriere}' LIKE '%' {Dami.Operator()} ""Descriere"" {Dami.Operator()} '%' ", new object[] { Session["CompletareChestionar_F10003"].ToString() });
        ...
        private ASPxGridView CreazaTabelOthers()
        {
            ...
            try
            {
                DataTable dt = General.IncarcaDT($@"SELECT ""PuncteForte"" FROM ""viewEvaluare360"" WHERE F10003 = @1 AND ""Descriere"" LIKE '%Others%' ", new object[] { Session["CompletareChestionar_F10003"].ToString() });
        ...
        private void PreluareDateAutomat(int idQuiz, int f10003, int pozitie)
        {
            try
            {
                string sqlUpd = "";
                ...
                DataTable dt = General.IncarcaDT(@"SELECT * FROM ""Eval_RaspunsIstoric"" WHERE ""IdQuiz""=@1 AND F10003=@2 AND ""Pozitie""<>@3", new object[] { idQuiz, f10003, pozitie });
