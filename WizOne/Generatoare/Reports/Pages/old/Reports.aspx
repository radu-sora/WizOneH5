...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">    
    <script>
        ...
        function AdjustSize() {
            ...
            reportsGridView.SetHeight(height);
        }
    ...
    <dx:ASPxGridView ID="ReportsGridView" ClientInstanceName="reportsGridView" runat="server" AutoGenerateColumns="False" Width="100%"
        ...
        <ClientSideEvents 
            ...
            }" EndCallback="function(s,e) { OnEndCallback(s,e); }" Init="OnInitGrid" />
    </dx:ASPxGridView>
                
        <asp:EntityDataSource ID="ReportsDataSource" runat="server" ConnectionString="name=ReportsEntities" DefaultContainerName="ReportsEntities" EntitySetName="Reports" Include="RaportGrupUtilizatori"
        EnableInsert="True" EnableUpdate="True" EnableDelete="True" Where="EXISTS (SELECT 1 FROM it.RaportGrupUtilizatori AS u WHERE u.IdUser = @UserId)">
        <WhereParameters>
            <asp:SessionParameter Name="UserId" Type="Int32" SessionField="UserId" />
        </WhereParameters>
    </asp:EntityDataSource>

    <asp:EntityDataSource ID="ReportTypesDataSource" runat="server" ConnectionString="name=ReportsEntities" DefaultContainerName="ReportsEntities" EntitySetName="ReportTypes" />
