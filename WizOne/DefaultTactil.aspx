    ...
    <form id="form1" runat="server">
        ...
        <div class="innerbuttonscard">
            <table>
                ...
                <tr>                  
                    <td colspan="3">
                        <dx:ASPxButton ID="btnLog" ClientInstanceName="btnLog" ClientIDMode="Static" runat="server" Width="260px" Height="30px" Text="Logare" style="font-size:30px;text-align:center" CssClass="divider" AutoPostBack="true" OnClick="btnLog_Click" oncontextMenu="ctx(this,event)"  RenderMode="Outline" meta:resourcekey="btnLog" >                                                                          
