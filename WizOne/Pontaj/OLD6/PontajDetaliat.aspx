...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function cmbProIndexChanged(s, e)
        {
            grCC.PerformCallback("cmbPro;" + s.GetSelectedItem().value);
        }

        function cmbSubProIndexChanged(s, e) {
            alert(s.GetSelectedItem().value);
            alert(cmbPro.GetSelectedItem().value);
            grCC.PerformCallback("cmbSubPro;" + cmbPro.GetSelectedItem().value + ";" + s.GetSelectedItem().value);
        }
                            ...
                            <dx:ASPxGridView ID="grCC" runat="server" ClientInstanceName="grCC" ClientIDMode="Static" Width="100%" AutoGenerateColumns="false" Visible="false" OnRowInserting="grCC_RowInserting" 
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataComboBoxColumn FieldName="IdProiect" Name="IdProiect" Caption="Proiect" Width="250px" VisibleIndex="3" Visible="false">
                                        <PropertiesComboBox TextField="Denumire" ValueField="Id" ValueType="System.Int32" DropDownStyle="DropDown" />
                                        <EditItemTemplate>
                                                <dx:ASPxComboBox ID="cmbPro" runat="server" ClientIDMode="Static" TextField="Denumire" ValueField="Id" Width="100%" ValueType="System.Int32">
                                                    <ClientSideEvents SelectedIndexChanged="function(s,e) { cmbProIndexChanged(s,e); }" />
                                                </dx:ASPxComboBox>
                                        </EditItemTemplate>
                                    </dx:GridViewDataComboBoxColumn>
                                    <dx:GridViewDataComboBoxColumn FieldName="IdSubproiect" Name="IdSubproiect" Caption="SubProiect" Width="250px" VisibleIndex="4" Visible="false">
                                        <PropertiesComboBox TextField="Denumire" ValueField="Id" ValueType="System.Int32" DropDownStyle="DropDown" />
                                        <EditItemTemplate>
                                                <dx:ASPxComboBox ID="cmbSubPro" runat="server" TextField="Denumire" ValueField="Id" Width="100%" ValueType="System.Int32" >
                                                    <ClientSideEvents SelectedIndexChanged="function(s,e) { cmbSubProIndexChanged(s,e); }" />
                                                </dx:ASPxComboBox>
                                        </EditItemTemplate>
                                    </dx:GridViewDataComboBoxColumn>
                                    <dx:GridViewDataComboBoxColumn FieldName="IdActivitate" Name="IdActivitate" Caption="Activitate" Width="250px" VisibleIndex="5" Visible="false">
                                        <PropertiesComboBox TextField="Denumire" ValueField="Id" ValueType="System.Int32" DropDownStyle="DropDown" />
                                        <EditItemTemplate>
                                                <dx:ASPxComboBox ID="cmbAct" runat="server" TextField="Denumire" ValueField="Id" Width="100%" ValueType="System.Int32" />
                                        </EditItemTemplate>
                                    </dx:GridViewDataComboBoxColumn>
