...
namespace WizOne.Personal
{
    public partial class Evolutie : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (General.VarSession("EsteAdmin").ToString() == "0") General.SecuritatePersonal(grDateEvolutie);
        }
        ...
        private void IncarcaGrid()
        {
            ...
            string sqlFinal = "SELECT * FROM \"Admin_Evolutie\" WHERE \"Marca\" = " + HttpContext.Current.Session["Marca"].ToString();
