<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Limbi.ascx.cs" Inherits="WizOne.Recrutare.Limbi" %>
...
<body>
    ...
    <table width="100%">
        <tr>
            <td >
                <dx:ASPxGridView ID="grDateLimbi" runat="server" ClientInstanceName="grDateLimbi" ClientIDMode="Static" Width="100%" AutoGenerateColumns="false"  OnDataBinding="grDateLimbi_DataBinding"  OnInitNewRow="grDateLimbi_InitNewRow"
