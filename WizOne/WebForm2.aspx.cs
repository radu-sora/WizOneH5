...
namespace WizOne
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = General.IncarcaDT("SELECT Id, Denumire, Id * 10 as Id_Tmp, CONVERT(datetime,DATEADD(minute, 480 - (10 * Id), '2019-01-01')) AS NrOre1_Tmp, CONVERT(int,480) AS NrOre1 FROM tblGrupUsers", null);
