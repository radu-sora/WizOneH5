...
namespace WizOne.Personal
{
    public partial class Atestate : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (General.VarSession("EsteAdmin").ToString() == "0") General.SecuritatePersonal(grDateAtestate);
        ...
        private void IncarcaGrid()
        {
            ...
            string sqlFinal = "SELECT * FROM \"Admin_Atestate\" WHERE \"Marca\" = " + HttpContext.Current.Session["Marca"].ToString();
